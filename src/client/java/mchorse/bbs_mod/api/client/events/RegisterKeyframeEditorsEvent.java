...
{
    public final Map<IKeyframeFactory, UIKeyframeFactory.IUIKeyframeFactoryFactory> factories;

    public RegisterKeyframeEditorsEvent()
    {
        this(UIKeyframeFactory.FACTORIES);
    }

    public RegisterKeyframeEditorsEvent(Map<IKeyframeFactory, UIKeyframeFactory.IUIKeyframeFactoryFactory> factories)
    {
