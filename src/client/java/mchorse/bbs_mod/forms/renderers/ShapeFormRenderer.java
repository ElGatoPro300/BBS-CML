...
public class ShapeFormRenderer extends FormRenderer<ShapeForm>
{
    ...
    protected void renderInUI(UIContext context, int x1, int y1, int x2, int y2)
    {
        ...
        this.renderShape(stack, null, OverlayTexture.DEFAULT_UV, LightmapTextureManager.MAX_LIGHT_COORDINATE);
    ...
    private void renderShape(MatrixStack stack, ShaderProgram shader, int overlay, int light)
    {
        this.renderShape(stack, shader, overlay, light, null);
    }

    private void renderShape(MatrixStack stack, ShaderProgram shader, int overlay, int light, FormRenderingContext renderContext)
    {
