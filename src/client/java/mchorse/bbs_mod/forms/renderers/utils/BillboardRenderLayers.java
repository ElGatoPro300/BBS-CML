...
public class BillboardRenderLayers
{
    ...
    private static RenderPipeline pipeline(boolean shaded, boolean depthWrite, boolean cull)
    {
        int index = (shaded ? 1 : 0) | (depthWrite ? 2 : 0) | (cull ? 4 : 0);
    ...
    public static void draw(BuiltBuffer buffer, Texture texture, boolean linear, boolean mipmap, boolean depthWrite, boolean cull)
    {
        ...
        RenderSetup.Builder setup = RenderSetup.builder(pipeline(shaded, depthWrite, cull))
