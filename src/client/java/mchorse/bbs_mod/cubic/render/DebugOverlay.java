...
/**
 * The shared drawing language of the model debug overlays: lines that can be
 * hairline or volumetric, solid or dashed, and markers in the
 * {@link ValueDebugElement} shapes. Everything is emitted in the overlay's
