...
public final class ModelPhysicsDebug
{
    ...
    private static void drawChain(MatrixStack stack, IModel model, Map<String, PivotFrame> frames, SpringChainCompiler.CompiledChain chain, String selectedRoot, ValuePhysicsDebug config)
    {
     ...
     * segment length.
     */
    private static void drawWind(MatrixStack stack, IModel model, Map<String, PivotFrame> frames, SpringChainCompiler.CompiledChain chain, String selectedRoot, WindDef wind, Vector3f windDir, float windMagnitude, int age, Matrix4f matrix, Matrix4f inverse, ValuePhysicsDebug config)
    {
        List<Vector3f> pts = chainPoints(model, frames, chain);
