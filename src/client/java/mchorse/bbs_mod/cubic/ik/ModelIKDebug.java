...
public final class ModelIKDebug
{
    ...
    private static void drawChain(PoseStack stack, Map<String, PivotFrame> frames, LimbConstraintCompiler.CompiledLimb limb, String selectedTip, ValueIKDebug config)
    {
