...
public class Draw
{
    ...
    private static final RenderPipeline POSITION_COLOR_LINES_NO_DEPTH = RenderPipelines.register(
        RenderPipelineUtils.withUniforms(RenderPipelines.DEBUG_FILLED_BOX)
            .withLocation(Identifier.fromNamespaceAndPath(BBSMod.MOD_ID, "pipeline/draw_position_color_lines_no_depth"))
            .withVertexShader("core/position_color")
            .withFragmentShader("core/position_color")
            .withVertexFormat(DefaultVertexFormat.POSITION_COLOR, VertexFormat.Mode.DEBUG_LINES)
            .withColorTargetState(new ColorTargetState(BLEND))
    ...
    private static RenderType positionColorLinesNoDepthLayer;
    ...
    public static RenderType getPositionColorLinesNoDepthLayer()
    {
        if (positionColorLinesNoDepthLayer == null)
        {
            positionColorLinesNoDepthLayer = RenderType.create(BBSMod.MOD_ID + "_draw_position_color_lines_no_depth",
