...
public class UILanguageEditorOverlayPanel extends UIOverlayPanel
{
    ...
    public UILanguageEditorOverlayPanel()
    {
        ...
        this.completion.background(Colors.A50 | BBSSettings.accentRgb()).labelAnchor(1F, 0.55F);
    ...
    private void renderMissingBackground(UIContext context)
    {
        if (this.viewMissing)
        {
            this.missing.area.render(context.batcher, Colors.A50 | BBSSettings.accentRgb(), 1);
        }
    }
