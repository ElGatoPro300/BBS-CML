...
public class ProceduralAnimator implements IAnimator
{
    ...
    public void applyActions(IEntity target, IModelInstance armature, float transition)
    {
        ...
        /* Film actors: never invent limb speed/phase from ActionPlayer lookahead
         * velocity — that is the idle→walk snap. LimbAnimator is driven like
         * StubEntity / vanilla from keyframe displacement (BaseFilmController). */
