...
public class ProceduralAnimator implements IAnimator
{
    ...
    public void applyActions(IEntity target, IModelInstance armature, float transition)
    {
        ...
        {
            /* Film actors get LimbAnimator from the stub on walk-start (BaseFilmController).
             * Inventing full speed + age phase from lookahead velocity caused a 1-tick
             * swing kick; skipping synthesis entirely lagged stubs by 1–2 ticks. */
            if (!filmActor)
            {
