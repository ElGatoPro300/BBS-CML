...
public class ValueGizmoToolbar extends BaseValue implements IIconToolbarValue
{
    ...
    public ValueGizmoToolbar(String id)
    {
        super(id);
    }
    ...
    {
        if (obj instanceof ValueGizmoToolbar)
        {
            ValueGizmoToolbar other = (ValueGizmoToolbar) obj;
