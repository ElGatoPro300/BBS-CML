...
public abstract class EditorLayoutNode
{
    ...
    public static EditorLayoutNode defaultMinecutLayout()
    {
        ...
        propsTabs.add(new PanelNode("minecutKeyframe"));
        propsTabs.add(new PanelNode("minecutPropsCamera"));
        propsTabs.add(new PanelNode("minecutPropsAction"));

        List<EditorLayoutNode> timelineTabs = new ArrayList<>();

        timelineTabs.add(new PanelNode("minecutTimelineReplay"));
        timelineTabs.add(new PanelNode("minecutTimelineCamera"));
        timelineTabs.add(new PanelNode("minecutTimelineAction"));
        ...
        return new SplitterNode(
            ...
            new SplitterNode(
                false,
                0.26F,
                new TabbedNode(mediaTabs, 0),
                new SplitterNode(
                    false,
                    0.46F,
                    new TabbedNode(propsTabs, 0),
                    new PanelNode("minecutPlayer")
                )
            ),
            new TabbedNode(timelineTabs, 0)
        );
    }
