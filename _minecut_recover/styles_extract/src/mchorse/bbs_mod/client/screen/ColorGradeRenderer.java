...
public class ColorGradeRenderer
{
    ...
    public static void apply(List<ColorEffect> effects, List<GrainEffect> grainEffects)
    {
        ...
        net.minecraft.class_276 fb = mc.method_1522();
    ...
    public static void resyncMinecraftState(Batcher2D batcher)
    {
        ...
        class_1044 atlas = mc.method_1531().method_4619(class_2960.method_60655("minecraft", "textures/atlas/blocks.png"));
        int textureId = atlas == null ? 0 : atlas.method_4624();
