...
public class ScreenEffectRenderer
{
    ...
    private static void renderLetterbox(Batcher2D batcher, LetterboxEffect effect, int screenW, int screenH)
    {
        ...
        if (transformed)
        {
            class_4587 stack = batcher.getContext().method_51448();

            stack.method_22903();
            stack.method_46416(effect.offsetX * screenW, effect.offsetY * screenH, 0F);
            stack.method_46416(screenW / 2F, screenH / 2F, 0F);
            stack.method_22907(class_7833.field_40718.rotation(MathUtils.toRad(effect.rotation)));
            stack.method_22905(zoom, zoom, 1F);
            stack.method_46416(-screenW / 2F, -screenH / 2F, 0F);
