...
public class BBSRendering
{
     ...
     * {@link class_4587} before entity transforms.
    ...
    private static class_4063 cachedCloudRenderMode;
     ...
     */
    public static class_276 getPaintOverlaySourceFramebuffer()
    {
        if (toggleFramebuffer && framebuffer != null)
        {
            return framebuffer;
    ...
    {
        Set<class_276> buffers = new HashSet<>();
        class_310 mc = class_310.method_1551();
    ...
    public static void resizeFramebuffer(class_276 framebuffer)
    {
        ...
        class_310 mc = class_310.method_1551();
        int w = Math.max(2, mc.method_22683().method_4489());
        int h = Math.max(2, mc.method_22683().method_4506());
    ...
    public static void toggleFramebuffer(boolean toggleFramebuffer)
    {
        ...
        {
            class_276 target = clientFramebuffer != null ? clientFramebuffer : mc.method_1522();
            ...
            {
                framebuffer.method_1237(fbW, fbH);
            }
        }
    }
    ...
    public static void onWorldRenderEnd()
    {
        ...
        if (BBSModClient.getCameraController().getCurrent() instanceof PlayCameraController controller)
        {
            ...
            class_1041 window = mc.method_22683();
            Area area = new Area(0, 0, window.method_4486(), window.method_4502());
            ...
            VideoRenderer.renderClips(batcher.getContext().method_51448(), batcher, controller.getContext().clips.getClips(controller.getContext().relativeTick), controller.getContext().relativeTick, true, area, area, null, area.w, area.h, false);
            ...
            RenderSystem.setProjectionMatrix(cache, class_8251.field_43361);
        }
        ...
        if (BBSModClient.getVideoRecorder().isRecording() && BBSModClient.getCameraController().getCurrent() instanceof CameraWorkCameraController controller)
        {
            ...
            renderHudOverlays(batcher, controller.getContext(), window.method_4486(), window.method_4502());
        }
        ...
        if (currentMenu instanceof UIDashboard dashboard)
        {
            if (dashboard.getPanels().panel instanceof UIFilmPanel panel && panel.needsViewportRender())
            {
                ...
                class_1041 window = mc.method_22683();
                Matrix4f cache = new Matrix4f(RenderSystem.getProjectionMatrix());
                Matrix4f ortho = new Matrix4f().ortho(0, window.method_4486(), window.method_4502(), 0, -1000, 3000);

                RenderSystem.setProjectionMatrix(ortho, class_8251.field_43361);
                Area fullScreen = new Area(0, 0, window.method_4486(), window.method_4502());
                VideoRenderer.renderClips(new class_4587(), offscreenBatcher, panel.getData().camera.getClips(panel.getCursor()), panel.getCursor(), panel.getRunner().isRunning(), fullScreen, fullScreen, null, window.method_4486(), window.method_4502(), false);

                ScreenEffectRenderer.render(offscreenBatcher, panel.getRunner().getContext(), window.method_4486(), window.method_4502());
    ...
    private static void updateCloudRenderMode(class_310 mc)
    {
        ...
        if (shouldHideClouds)
        {
            if (!cloudsForced)
            {
                cachedCloudRenderMode = mc.field_1690.method_42528().method_41753();
                cloudsForced = true;
            }
        ...
        else if (cloudsForced)
        {
            ...
            {
                mc.field_1690.method_42528().method_41748(cachedCloudRenderMode);
            }
    ...
    public static void onRenderBeforeScreen()
    {
        ...
        texture.bind();
        texture.setSize(framebuffer.field_1482, framebuffer.field_1481);
        GL11.glCopyTexSubImage2D(GL11.GL_TEXTURE_2D, 0, 0, 0, 0, 0, framebuffer.field_1482, framebuffer.field_1481);
        texture.unbind();
    ...
    public static void onRenderChunkLayer(class_4587 stack)
    {
        ...
        worldRenderContext.prepare(
            mc.field_1769, mc.method_60646(), false,
            mc.field_1773.method_19418(), mc.field_1773, mc.field_1773.method_22974(),
            RenderSystem.getProjectionMatrix(), RenderSystem.getModelViewMatrix(), mc.method_22940().method_23000(), mc.method_16011(), false, mc.field_1687
        );
    ...
    public static void renderHud(class_332 drawContext, float tickDelta)
    {
        ...
        if (showRecordingOverlay)
        {
            ...
            String label = UIKeys.FILM_VIDEO_RECORDING.format(
                count,
                BBSModClient.getKeyRecordVideo().method_16007().getString()
            ).get();
    ...
    private static void renderSelectedReplayHud(class_332 drawContext, Batcher2D batcher2D, int yOffset)
    {
        ...
        if (hasForm)
        {
            ...
            replayHudMenu.resize(window.method_4486(), window.method_4502());
        ...
        if (hasLabel)
        {
            ...
            drawContext.method_51448().method_22905(textScale, textScale, 1F);
    ...
    {
        if (class_310.method_1551().field_1755 instanceof UIScreen screen)
        {
     ...
     */
    public static boolean shouldHideChromaBlockEntity(class_2586 blockEntity)
    {
    ...
    public static Function<class_4588, class_4588> getColorConsumer(Color color, Color paintColor)
    {
    ...
    public static Function<class_4588, class_4588> getBlockPaintConsumer(Color color, Color paintColor)
    {
        if (paintColor == null || paintColor.a == 0F)
        {
            return getColorConsumer(color);
    ...
    public static Function<class_4588, class_4588> getGlowOverlayConsumer(Color glowColor)
    {
        if (sodium)
        {
    ...
    public static Function<class_4588, class_4588> getTextGlowOverlayConsumer(Color glowColor)
    {
        if (sodium)
        {
    ...
    public static Function<class_4588, class_4588> getBlockPaintOverlayConsumer(Color paintColor)
    {
        if (sodium)
        {
     ...
     */
    public static Function<class_4588, class_4588> getBlockColorTintOverlayConsumer()
    {
    ...
    private static void renderHudOverlays(Batcher2D batcher, ClipContext context, int width, int height)
    {
        ...
        class_4587 matrices = batcher.getContext().method_51448();
        int subtitleIndex = 0;
        int hotbarIndex = 0;
        int imageIndex = 0;
        int bossBarIndex = 0;
