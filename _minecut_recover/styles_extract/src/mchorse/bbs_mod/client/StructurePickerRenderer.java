...
public class StructurePickerRenderer
{
     ...
     */
    private static void renderPlacementGhostForm(class_4587 stack, WorldRenderContext context)
    {
        StructureForm form = StructurePickerClient.getPlacementPreviewForm();
        class_2338 min = StructurePickerClient.getPlacementOrigin();
        class_2338 max = StructurePickerClient.getPlacementMax();
        ...
        int light = class_761.method_23794(world, placement);
        ...
        stack.method_22903();
        stack.method_22904(placement.method_10263() + 0.5D, placement.method_10264(), placement.method_10260() + 0.5D);

        FormRenderingContext formContext = new FormRenderingContext()
            .set(FormRenderType.MODEL_BLOCK, null, stack, light, class_4608.field_21444, tickDelta)
    ...
    private static void renderSelectionVolumes(float edgeAlpha, float fillAlpha, class_4587 stack)
    {
        ...
        if (paintStyle)
        {
            ...
            if (lod != null)
            {
                ...
                class_2338 min = StructurePickerClient.getSelectionBoundsMin();
                class_2338 max = StructurePickerClient.getSelectionBoundsMax();
    ...
    private static void renderBrushPreview(float edgeAlpha, float fillAlpha, class_4587 stack)
    {
    ...
    private static void renderRegionAabbs(class_4587 stack, List<StructurePickerClient.Region> regions, float r, float g, float b, float edgeAlpha, float fillAlpha)
    {
        if (regions.isEmpty())
        {
            return;
        ...
        StructurePickerRenderer.beginAabbBatch(stack, r, g, b, edgeAlpha, fillAlpha, regions.size(), (i, out) ->
        {
            ...
            out[0] = min.method_10263();
            out[1] = min.method_10264();
            out[2] = min.method_10260();
            out[3] = max.method_10263() - min.method_10263() + 1D;
            out[4] = max.method_10264() - min.method_10264() + 1D;
            out[5] = max.method_10260() - min.method_10260() + 1D;
        });
    }

    private static void renderMergedAabbs(class_4587 stack, List<StructurePickerRegionMerger.MergedRegion> regions, float r, float g, float b, float edgeAlpha, float fillAlpha)
    {
        if (regions.isEmpty())
        {
            return;
     ...
     */
    private static void beginAabbBatch(class_4587 stack, float r, float g, float b, float edgeAlpha, float fillAlpha, int count, AabbWriter writer)
    {
        ...
        if (fillAlpha > 0.001F)
        {
            class_287 fill = class_289.method_1348().method_60827(class_293.class_5596.field_27379, class_290.field_1576);

            for (int i = 0; i < count; i++)
            {
                writer.write(i, box);
                stack.method_22903();
                stack.method_22904(box[0] - e, box[1] - e, box[2] - e);
                Draw.fillBox(
                    fill,
                    stack,
                    0F,
            ...
            class_286.method_43433(fill.method_60800());
        }
        ...
        class_287 edges = class_289.method_1348().method_60827(class_293.class_5596.field_27379, class_290.field_1576);
        ...
        class_286.method_43433(edges.method_60800());
    }

    private static void appendBoxEdges(class_287 builder, class_4587 stack, double x, double y, double z, double w, double h, double d, float r, float g, float b, float a)
    {
        float fw = (float) w;
        float fh = (float) h;
        float fd = (float) d;
    ...
    private static void renderSelectionGizmos(class_4587 stack)
    {
    ...
    private static void renderPlacementOverlayVolumes(class_4587 stack, float edgeAlpha)
    {
        class_2338 min = StructurePickerClient.getPlacementOrigin();
        class_2338 max = StructurePickerClient.getPlacementMax();
        ...
        double sizeX = max.method_10263() - min.method_10263() + 1D;
        double sizeY = max.method_10264() - min.method_10264() + 1D;
        double sizeZ = max.method_10260() - min.method_10260() + 1D;
        double e = VOLUME_EXPAND;

        Draw.renderBox(stack, min.method_10263() - e, min.method_10264() - e, min.method_10260() - e, sizeX + e * 2D, sizeY + e * 2D, sizeZ + e * 2D, 1F, 1F, 0.35F, edgeAlpha);
    }

    private static void renderPlacementOverlayGizmos(class_4587 stack)
    {
    ...
    private static void renderPlacementGizmo(class_4587 stack, class_243 center)
    {
        double ox = center.field_1352;
        double oy = center.field_1351;
        double oz = center.field_1350;
    ...
    {
        class_2338 pos = StructurePickerClient.getModelBlockFlashPos();
        ...
        Draw.renderBox(stack, pos.method_10263(), pos.method_10264(), pos.method_10260(), 1D, 1D, 1D, 0F, 0.5F, 1F, alpha);
        stack.method_22909();
    ...
    private static void renderRegionBox(class_4587 stack, class_2338 first, class_2338 second, StructurePickerMode mode, class_2350 triangleFacing, float r, float g, float b, float edgeAlpha, float fillAlpha)
    {
        ...
        StructurePickerRenderer.renderExpandedVolume(stack, min.method_10263(), min.method_10264(), min.method_10260(), sizeX, sizeY, sizeZ, r, g, b, edgeAlpha, fillAlpha);
    }

    private static void renderMergedBlockBox(class_4587 stack, class_2338 min, class_2338 max, float r, float g, float b, float edgeAlpha, float fillAlpha)
    {
        double sizeX = max.method_10263() - min.method_10263() + 1D;
        double sizeY = max.method_10264() - min.method_10264() + 1D;
        double sizeZ = max.method_10260() - min.method_10260() + 1D;
    ...
    private static void renderExpandedVolume(class_4587 stack, double x, double y, double z, double w, double h, double d, float r, float g, float b, float edgeAlpha, float fillAlpha)
    {
        double e = VOLUME_EXPAND;
    ...
    private static void renderVolumeFill(class_4587 stack, double x, double y, double z, double w, double h, double d, float r, float g, float b, float a)
    {
        if (a <= 0.001F)
        {
            return;
    ...
    private static void renderCubeCorners(class_4587 stack, class_2338 first, class_2338 second)
    {
        ...
        float hMin = CORNER_HANDLE * StructurePickerClient.getHandleVisualScale(min.method_10263(), min.method_10264(), min.method_10260());
        float hMax = CORNER_HANDLE * StructurePickerClient.getHandleVisualScale(max.method_10263() + 1, max.method_10264() + 1, max.method_10260() + 1);

        StructurePickerRenderer.renderCornerHandle(stack, min.method_10263(), min.method_10264(), min.method_10260(), hMin, pulse);
        StructurePickerRenderer.renderCornerHandle(stack, max.method_10263() + 1, max.method_10264() + 1, max.method_10260() + 1, hMax, pulse);
    }

    private static void renderCornerHandle(class_4587 stack, double x, double y, double z, float h, float alpha)
    {
        float rim = h * 1.18F;
    ...
    private static void renderResizeGizmo(class_4587 stack, class_2338 freeCorner)
    {
        if (freeCorner == null)
        {
            return;
        ...
        double ox = freeCorner.method_10263();
        double oy = freeCorner.method_10264();
        double oz = freeCorner.method_10260();
    ...
    private static void renderScaleAxis(class_4587 stack, double ox, double oy, double oz, StructurePickerAxis axis, float len, float t, float knob, float r, float g, float b, boolean highlight)
    {
     ...
     */
    private static void renderTranslateAxis(class_4587 stack, double ox, double oy, double oz, StructurePickerAxis axis, float len, float t, float r, float g, float b, boolean highlight)
    {
    ...
    private static void renderAxisArm(class_4587 stack, double ox, double oy, double oz, StructurePickerAxis axis, float len, float t, float r, float g, float b, boolean highlight)
    {
