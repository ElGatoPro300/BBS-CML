...
public class ImageClip extends CameraClip
{
    ...
    public void clampLimitedValues()
    {
        ...
        this.uniform.blend.set(class_3532.method_15350(this.uniform.blend.get(), BLEND_MIN, BLEND_MAX));
        this.uniform.opacity.set(class_3532.method_15350(this.uniform.opacity.get(), OPACITY_MIN, OPACITY_MAX));
    }
    ...
    private void clampChannel(KeyframeChannel<Double> channel, double min, double max)
    {
        for (Keyframe<Double> keyframe : channel.getKeyframes())
        {
            ...
            double clamped = class_3532.method_15350(value, min, max);
    ...
    protected void applyClip(ClipContext context, Position position)
    {
        ...
        float alpha = factor * (float) class_3532.method_15350(this.valueDouble(this.opacity, this.uniform.opacity, t, 1D), OPACITY_MIN, OPACITY_MAX);
    ...
    public void ensureUniformSeeded(float tick)
    {
        ...
        this.uniform.blend.set(class_3532.method_15350(this.interp(this.blend, tick, 0D), BLEND_MIN, BLEND_MAX));
        ...
        this.uniform.opacity.set(class_3532.method_15350(this.interp(this.opacity, tick, 1D), OPACITY_MIN, OPACITY_MAX));
    ...
    public void ensureChannelsSeeded(float tick)
    {
        ...
        this.seedDouble(this.blend, class_3532.method_15350(this.uniform.blend.get(), BLEND_MIN, BLEND_MAX));
        ...
        this.seedDouble(this.opacity, class_3532.method_15350(this.uniform.opacity.get(), OPACITY_MIN, OPACITY_MAX));
    ...
    {
        float blendValue = (float) class_3532.method_15350(this.valueDouble(this.blend, this.uniform.blend, t, 0D), BLEND_MIN, BLEND_MAX);
