...
public class GunProperties extends ModelProperties
{
    ...
    public static GunProperties get(class_1799 stack)
    {
    ...
    private static void setupDefault(GunProperties properties)
    {
        ...
        value.particle = class_2960.method_60655("minecraft", "falling_water");
    ...
    public void fromNetwork(class_2540 buf)
    {
    ...
    public void toNetwork(class_2540 buf)
    {
        ...
        buf.method_52964(this.useTarget);
        buf.method_53002(this.lifeSpan);
        buf.method_52941(this.speed);
        buf.method_52941(this.friction);
        buf.method_52941(this.gravity);
        buf.method_52964(this.yaw);
        buf.method_52964(this.pitch);
        buf.method_53002(this.fadeIn);
        buf.method_53002(this.fadeOut);

        buf.method_53002(this.bounces);
        buf.method_52941(this.bounceDamping);
        buf.method_52964(this.vanish);
        buf.method_52941(this.damage);
        buf.method_52941(this.knockback);
        buf.method_52964(this.collideBlocks);
        buf.method_52964(this.collideEntities);
    }
