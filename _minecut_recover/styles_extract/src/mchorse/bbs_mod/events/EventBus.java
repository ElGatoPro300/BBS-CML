...
public class EventBus
{
     ...
     * Walks the class hierarchy so {@code @Subscribe} handlers on
     * {@link mchorse.bbs_mod.addons.BBSAddon} / {@link mchorse.bbs_mod.addons.BBSClientAddon}
     * base classes are found when only overrides live on the concrete addon.
     */
