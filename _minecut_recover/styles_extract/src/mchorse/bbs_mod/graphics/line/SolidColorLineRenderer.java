...
public class SolidColorLineRenderer implements ILineRenderer
{
    ...
    @Override
    public void render(class_287 builder, Matrix4f matrix, LinePoint point)
    {
        builder.method_22918(matrix, point.x, point.y, 0F).method_22915(this.color.r, this.color.g, this.color.b, this.color.a);
    }
}
