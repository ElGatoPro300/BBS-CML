...
public class UISettingsOverlayPanel extends UIOverlayPanel
{
    ...
    private Icon getCategoryIcon(String categoryId)
    {
        switch (categoryId)
        {
            ...
            case "minecut_ui": return Icons.FILM;
    ...
    public void refresh()
    {
        ...
        for (ValueGroup category : this.settings.categories.values())
        {
            ...
            UILabel label = UI.label(L10n.lang(catTitleKey)).labelAnchor(0, 1).color(BBSSettings.primaryColor(Colors.A100)).background(BBSSettings::raisedSurface);
    ...
    protected void renderBackground(UIContext context)
    {
        ...
        // Left sidebar
        context.batcher.box(this.sidebarContainer.area.x, this.sidebarContainer.area.y, this.sidebarContainer.area.ex(), this.sidebarContainer.area.ey(), BBSSettings.deepSurface());
        context.batcher.outline(this.sidebarContainer.area.x, this.sidebarContainer.area.y, this.sidebarContainer.area.ex(), this.sidebarContainer.area.ey(), BBSSettings.dividerColor(), 1);
