...
public class Recorder extends WorldFilmController
{
    ...
    public static void renderCameraPreview(Position position, class_4184 camera, class_4587 stack, float r, float g, float b, float a, boolean drawForward)
    {
    ...
    public static void renderCameraPreviewTimeline(Clips clips, int tick, float transition, int duration, Position current, class_4184 camera, class_4587 stack)
    {
    ...
    private static void fillPreviewSegment(class_287 builder, class_4587 stack, float x1, float y1, float z1, float x2, float y2, float z2, float thickness, float r, float g, float b, float a)
    {
        float dx = x2 - x1;
        float dy = y2 - y1;
        float dz = z2 - z1;
