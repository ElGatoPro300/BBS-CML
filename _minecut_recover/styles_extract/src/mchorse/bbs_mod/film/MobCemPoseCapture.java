...
public class MobCemPoseCapture
{
    ...
    public static Pose sampleMobPose(MobForm mobForm, IEntity entity, float transition)
    {
        ...
        Map<String, class_630> parts = renderer.sampleVanillaParts(entity, transition);
    ...
    public static Pose partsToPose(Map<String, class_630> parts)
    {
        Pose pose = new Pose();
        ...
        for (Map.Entry<String, class_630> entry : parts.entrySet())
        {
            ...
            transform.rotate.set(part.field_3654, part.field_3675, part.field_3674);
            transform.pivot.set(part.field_3657, part.field_3656, part.field_3655);
            transform.scale.set(part.field_37938, part.field_37939, part.field_37940);
        }
