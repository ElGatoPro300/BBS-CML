...
public class FormRenderDepth
{
    ...
    public static List<Occluder> collectOccluders(IntObjectMap<IEntity> entities, net.minecraft.class_4184 camera, float transition, Function<Integer, Form> sourceFormProvider)
    {
        class_243 pos = camera.method_19326();

        return collectOccluders(entities, pos.field_1352, pos.field_1351, pos.field_1350, transition, sourceFormProvider);
    }
    ...
    public static double getEntityDistanceSq(IEntity entity, net.minecraft.class_4184 camera, float transition)
    {
        class_243 pos = camera.method_19326();

        return getEntityDistanceSq(entity, pos.field_1352, pos.field_1351, pos.field_1350, transition);
    }
