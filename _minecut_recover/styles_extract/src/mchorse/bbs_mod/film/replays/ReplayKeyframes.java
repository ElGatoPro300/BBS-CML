...
public class ReplayKeyframes extends ValueGroup
{
    ...
    public final KeyframeChannel<class_1799> mainHand = new KeyframeChannel<>("item_main_hand", KeyframeFactories.ITEM_STACK);
    public final KeyframeChannel<class_1799> offHand = new KeyframeChannel<>("item_off_hand", KeyframeFactories.ITEM_STACK);
    public final KeyframeChannel<class_1799> armorHead = new KeyframeChannel<>("item_head", KeyframeFactories.ITEM_STACK);
    public final KeyframeChannel<class_1799> armorChest = new KeyframeChannel<>("item_chest", KeyframeFactories.ITEM_STACK);
    public final KeyframeChannel<class_1799> armorLegs = new KeyframeChannel<>("item_legs", KeyframeFactories.ITEM_STACK);
    public final KeyframeChannel<class_1799> armorFeet = new KeyframeChannel<>("item_feet", KeyframeFactories.ITEM_STACK);
    ...
    public void record(float tick, IEntity entity, List<String> groups)
    {
        ...
        this.activeHand.insert(tick, entity.getActiveHand() == class_1268.field_5810 ? 1D : 0D);
    ...
    public void apply(int tick, IEntity entity, List<String> groups)
    {
        ...
        entity.setActiveHand(this.activeHand.interpolate(tick) > 0D ? class_1268.field_5810 : class_1268.field_5808);
    ...
    private int getItemUseElapsed(IEntity entity)
    {
        ...
        if (entity instanceof MCEntity mcEntity && mcEntity.getMcEntity() instanceof class_1309 living)
        {
            max = stack.method_7935(living);
        }
