...
public abstract class ParticleComponentExpireBlocks extends ParticleComponentBase
{
    ...
    public class_2680 getBlock(ParticleEmitter emitter, Particle particle)
    {
        ...
        return emitter.world.method_8320(new class_2338((int) position.x, (int) position.y, (int) position.z));
    }
}