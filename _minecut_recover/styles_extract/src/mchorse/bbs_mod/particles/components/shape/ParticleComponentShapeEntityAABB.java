...
public class ParticleComponentShapeEntityAABB extends ParticleComponentShapeBase
{
    ...
    public void apply(ParticleEmitter emitter, Particle particle)
    {
        ...
        {
            class_238 box = emitter.target.method_5829();

            w = (float) (box.field_1320 - box.field_1323);
            h = (float) (box.field_1325 - box.field_1322);
            d = (float) (box.field_1324 - box.field_1321);
        }
