...
public class ParticleEmitter
{
    ...
    {
        this.target = target;
        this.world = target == null ? null : target.method_37908();
    }
     ...
     */
    public void renderUI(class_4587 stack, float transition)
    {
        if (this.scheme == null)
        {
            return;
     ...
     */
    public void render(class_293 format, Supplier<class_5944> program, class_4587 stack, int overlay, float transition)
    {
        if (this.scheme == null)
        {
            return;
    ...
    private void renderGlowOverlay(class_4587 stack, float transition, boolean ui)
    {
        this.renderGlowOverlay(stack, class_4608.field_21444, transition, ui);
    }

    private void renderGlowOverlay(class_4587 stack, int overlay, float transition, boolean ui)
    {
    ...
    public void setupCameraProperties(net.minecraft.class_4184 camera)
    {
        this.cYaw = 180 - camera.method_19330();
        this.cPitch = -camera.method_19329();
        this.cX = camera.method_19326().field_1352;
        this.cY = camera.method_19326().field_1351;
        this.cZ = camera.method_19326().field_1350;
    }
}
