...
public class ShapeFormRenderer extends FormRenderer<ShapeForm>
{
    ...
    protected void renderInUI(UIContext context, int x1, int y1, int x2, int y2)
    {
        ...
        stack.method_22907(class_7833.field_40716.rotationDegrees(context.getTransition() * 2));
        stack.method_22907(class_7833.field_40714.rotationDegrees(20));
        ...
        this.renderShape(stack, class_757::method_34508, class_4608.field_21444, class_765.field_32767, null);
    ...
    {
        Supplier<class_5944> shader = BBSRendering.isIrisShadersEnabled()
    ...
    private void renderShape(class_4587 stack, Supplier<class_5944> shader, int overlay, int light, FormRenderingContext renderContext)
    {
        ...
        // Transform
        stack.method_22903();
        stack.method_22905(this.form.sizeX.get(), this.form.sizeY.get(), this.form.sizeZ.get());
        ...
        else
        {
            ...
            class_287 builder = tessellator.method_60827(class_293.class_5596.field_27382, class_290.field_1580);
            ...
            if (positiveGlow)
            {
                ...
                Supplier<class_5944> unshadedShader = class_757::method_34543;
                ...
                this.buildShapeGeometry(glowBuilder, stack, type, glowColor, overlay, class_765.field_32767);
    ...
    private void drawDeferredShape(class_4587 stack, Link texture, ShapeForm.ShapeType type, Color color, int overlay, int light, boolean lighting, boolean positiveGlow, GlowSettings glowSettings, Color legacyGlow, float glowIntensity, Supplier<class_5944> shader, boolean unshaded)
    {
        if (texture != null)
        {
            BBSModClient.getTextures().bindTexture(texture);
        ...
        class_289 tessellator = class_289.method_1348();
        class_287 builder = tessellator.method_60827(
            class_293.class_5596.field_27382,
            unshaded ? class_290.field_1575 : class_290.field_1580
        );
    ...
    private void buildShapeGeometry(class_287 builder, class_4587 stack, ShapeForm.ShapeType type, Color c, int overlay, int light)
    {
    ...
    private void renderVolumeParticles(class_287 builder, class_4587 stack, ShapeForm.ShapeType type, Color c, int overlay, int light)
    {
    ...
    private void renderCrossedParticle(class_287 builder, Matrix4f matrix, Matrix3f normalMatrix, float x, float y, float z, float size, Color c, int overlay, int light)
    {
        float hs = size / 2;
    ...
    private void renderBlockParticle(class_287 builder, Matrix4f matrix, Matrix3f normal, float x, float y, float z, float size, Color c, int overlay, int light)
    {
        float hs = size / 2;
    ...
    private void renderSphereParticle(class_287 builder, Matrix4f matrix, Matrix3f normalMatrix, float x, float y, float z, float size, Color c, int overlay, int light)
    {
        if (this.evaluator != null)
        {
            int color = this.evaluator.computeColor(x, y, z, this.time);
    ...
    private void renderDustParticle(class_287 builder, Matrix4f matrix, Matrix3f normalMatrix, float x, float y, float z, float size, Color c, int overlay, int light)
    {
        if (this.evaluator != null)
        {
            int color = this.evaluator.computeColor(x, y, z, this.time);
    ...
    private void renderBox(class_287 builder, class_4587 stack, Color c, int overlay, int light)
    {
        Matrix4f matrix = stack.method_23760().method_23761();
    ...
    private void renderSphere(class_287 builder, class_4587 stack, Color c, int overlay, int light)
    {
        Matrix4f matrix = stack.method_23760().method_23761();
        Matrix3f normalMatrix = stack.method_23760().method_23762();
    ...
    private void renderCylinder(class_287 builder, class_4587 stack, boolean capsule, Color c, int overlay, int light)
    {
        Matrix4f matrix = stack.method_23760().method_23761();
        Matrix3f normalMatrix = stack.method_23760().method_23762();
    ...
    private void vertex(class_287 builder, Matrix4f matrix, Matrix3f normalMatrix, float x, float y, float z, float u, float v, float nx, float ny, float nz, Color c, int overlay, int light)
    {
        ...
        {
            builder.method_22918(matrix, x, y, z)
                   .method_22913(u, v)
                   .method_22915(c.r, c.g, c.b, c.a);
        }
        else if (this.overlayVertexMode == OverlayVertexMode.PAINT)
        {
            ...
            builder.method_22918(matrix, x, y, z)
                   .method_22915(c.r, c.g, c.b, c.a * mask)
                   .method_22913(u, v)
    ...
    private void submitDeferredShapePaintOverlay(class_4587 stack, Link texture, ShapeForm.ShapeType type, Color resolvedPaint, float alpha, EffectTransform paintTransform, GlowSettings glowSettings, Color legacyGlow, float glowIntensity)
    {
        Matrix4f positionMatrix = ModelVAORenderer.capturePaintOverlayRootMatrix(new Matrix4f(stack.method_23760().method_23761()));
        Matrix3f normalMatrix = new Matrix3f(stack.method_23760().method_23762());
        ...
        ModelVAORenderer.submitPaintOverlay(false, () ->
        {
            ...
            this.renderShapePaintOverlay(overlayStack, textureSnapshot, typeSnapshot, paintOverlay, class_4608.field_21444, paintTransformSnapshot, glowSettingsSnapshot, legacyGlowSnapshot, glowIntensitySnapshot);
        });
    }

    private void renderShapePaintOverlay(class_4587 stack, Link texture, ShapeForm.ShapeType type, Color paintOverlay, float alpha, EffectTransform paintTransform, GlowSettings glowSettings, Color legacyGlow, float glowIntensity)
    {
        Color paint = new Color(paintOverlay.r, paintOverlay.g, paintOverlay.b, paintOverlay.a);

        paint.a *= alpha;
        this.renderShapePaintOverlay(stack, texture, type, paint, class_4608.field_21444, paintTransform, glowSettings, legacyGlow, glowIntensity);
    }

    private void renderShapePaintOverlay(class_4587 stack, Link texture, ShapeForm.ShapeType type, Color paintOverlay, int overlay, EffectTransform paintTransform, GlowSettings glowSettings, Color legacyGlow, float glowIntensity)
    {
        if (texture != null)
        {
            BBSModClient.getTextures().bindTexture(texture);
    ...
    private void submitDeferredShapeColorTintOverlay(class_4587 stack, Link texture, ShapeForm.ShapeType type, Color formTintColor, int overlay, EffectTransform colorTransform)
    {
        Matrix4f positionMatrix = ModelVAORenderer.capturePaintOverlayRootMatrix(new Matrix4f(stack.method_23760().method_23761()));
        Matrix3f normalMatrix = new Matrix3f(stack.method_23760().method_23762());
    ...
    private void renderShapeColorTintOverlay(class_4587 stack, Link texture, ShapeForm.ShapeType type, Color formTintColor, int overlay, EffectTransform colorTransform)
    {
        if (texture != null)
        {
            BBSModClient.getTextures().bindTexture(texture);
