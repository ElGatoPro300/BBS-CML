...
public class FluidFormRenderer extends FormRenderer<FluidForm> implements ITickable
{
    ...
    protected void renderInUI(UIContext context, int x1, int y1, int x2, int y2)
    {
        ...
        stack.method_46416(0F, 0.5F, 0F); /* Center it a bit */
        ...
        this.renderFluid(format, class_757::method_34508,
            stack,
    ...
    private void renderDebug(FormRenderingContext context)
    {
        ...
        class_287 builder = class_289.method_1348().method_60827(class_293.class_5596.field_27377, class_290.field_29337);
        ...
        for (FluidController.FluidSample sample : this.controller.lastDebugSamples)
        {
            ...
            stack.method_22903();
            stack.method_46416(sample.localPos.x, sample.localPos.y, sample.localPos.z);
            ...
            for (int i = 0; i < segments; i++)
            {
                ...
                /* XY circle */
                builder.method_22918(matrix, c1, s1, 0).method_22915(1f, 0f, 0f, 1f).method_22914(nx1, ny1, nz1);
                builder.method_22918(matrix, c2, s2, 0).method_22915(1f, 0f, 0f, 1f).method_22914(nx1, ny1, nz1);
                
                /* XZ circle */
                builder.method_22918(matrix, c1, 0, s1).method_22915(1f, 0f, 0f, 1f).method_22914(nx2, ny2, nz2);
                builder.method_22918(matrix, c2, 0, s2).method_22915(1f, 0f, 0f, 1f).method_22914(nx2, ny2, nz2);
                
                /* YZ circle */
                builder.method_22918(matrix, 0, c1, s1).method_22915(1f, 0f, 0f, 1f).method_22914(nx3, ny3, nz3);
                builder.method_22918(matrix, 0, c2, s2).method_22915(1f, 0f, 0f, 1f).method_22914(nx3, ny3, nz3);
            }
    ...
    private void renderFluid(class_293 format, Supplier<class_5944> shader, class_4587 matrices, int overlay, int light, int overlayColor, float transition)
    {
        ...
        class_287 builder = tessellator.method_60827(class_293.class_5596.field_27379, format);
    ...
    private void renderProceduralOcean(class_287 builder, class_4587 matrices, Color color, int overlay, int light)
    {
        ...
        {
            time = (class_310.method_1551().field_1724.field_6012 + class_310.method_1551().method_60646().method_60637(true)) * speed * 0.1f;
        }
        else
        {
    ...
    private void renderOcean(class_287 builder, class_4587 matrices, Color color, int overlay, int light)
    {
        float scaleX = Math.max(this.form.sizeX.get(), 0.001f);
        float scaleZ = Math.max(this.form.sizeZ.get(), 0.001f);
    ...
    private void renderDrop(class_287 builder, class_4587 matrices, Color color, int overlay, int light)
    {
    ...
    private void addVertex(class_287 builder, Matrix4f matrix, Matrix3f normal, float x, float y, float z, float u, float v, Color color, int overlay, int light, Vector3f n)
    {
         Vector3f tn = new Vector3f(n);
         tn.mul(normal);

         builder.method_22918(matrix, x, y, z)
               .method_1336((int) (color.r * 255), (int) (color.g * 255), (int) (color.b * 255), (int) (color.a * 255))
               .method_22913(u, v)
               .method_22922(overlay)
               .method_60803(light)
               .method_22914(tn.x, tn.y, tn.z);
    }
