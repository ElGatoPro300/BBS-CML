...
public class ModelFormRenderer extends FormRenderer<ModelForm> implements ITickable
{
    ...
    public void renderInUI(UIContext context, int x1, int y1, int x2, int y2)
    {
        ...
        if (this.animator != null && model != null)
        {
            ...
            if (FormUtilsClient.isUIPreviewAnimating() && this.animator != null)
            {
                ...
                int tick = client.field_1687 != null ? (int) (client.field_1687.method_8510() & 0x7FFFFFFF) : this.lastUiAnimTick + 1;
            ...
            Supplier<class_5944> mainShader = this.getModelShader(model);

            this.renderModel(this.entity, mainShader, stack, model, class_765.method_23687(15, 15), class_4608.field_21444, color, true, null, context.getTransition(), true, null, null);
    ...
    private void renderModel(IEntity target, Supplier<class_5944> program, class_4587 stack, ModelInstance model, int light, int overlay, Color color, boolean ui, StencilMap stencilMap, float transition, boolean renderEquipment, class_4587 world, FormRenderingContext renderContext)
    {
        ...
        newStack.method_23760().method_23762().set(stack.method_23760().method_23762());
        ...
        Matrix4f baseTransform = ui ? null : new Matrix4f((world != null ? world : stack).method_23760().method_23761());
        ...
        if (stencilMap != null)
        {
            Color stencilFormColor = this.form.getFormColor().copyWithBlendIntensity();
        ...
        try
        {
            ...
            if (deferTranslucentModel)
            {
                ...
                Matrix4f positionMatrix = ModelVAORenderer.capturePaintOverlayRootMatrix(new Matrix4f(newStack.method_23760().method_23761()));
                Matrix3f normalMatrix = new Matrix3f(newStack.method_23760().method_23762());
            ...
            if (drawIrisLive)
            {
                ...
                if (delaySoftOpacity)
                {
                    ...
                    Matrix4f positionMatrix = irisCamera
                        ? new Matrix4f(newStack.method_23760().method_23761())
                        : ModelVAORenderer.capturePaintOverlayRootMatrix(new Matrix4f(newStack.method_23760().method_23761()));
                    Matrix3f normalMatrix = new Matrix3f(newStack.method_23760().method_23762());
                    Matrix4f baseTransformSnapshot = baseTransform == null ? null : new Matrix4f(baseTransform);
                    Color colorSnapshot = color.copy();
                    Color paintSnapshot = paintColor.copy();
                    ...
                    int overlayLight = light;
                    int overlayOverlay = overlay;
                    Supplier<class_5944> programSnapshot = (irisCamera && !gradeActiveSnapshot)
                        ? program
                        : BBSShaders::getModel;
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        Supplier<class_5944> geometryProgram = uploadFormGradeToShader
                            ? BBSShaders::getModel
                            : program;
        ...
        {
            this.renderItems(target, model, stack, class_1304.field_6173, class_811.field_4320, model.itemsMain, model.itemsMainTransform, color, overlay, light);
            this.renderItems(target, model, stack, class_1304.field_6171, class_811.field_4323, model.itemsOff, model.itemsOffTransform, color, overlay, light);
    ...
    private void renderDeferredGlowEmission(class_4587 stack, ModelInstance model, int light, int overlay, StencilMap stencilMap, Color color, Link defaultTexture, TextureBlend textureBlend, GlowSettings glow, Color glowColor, Color legacyGlow)
    {
        ...
        ModelVAORenderer.runWithPaintOverlayPass(false, () ->
        {
            ...
            try
            {
                this.renderModelGeometry(stack, BBSShaders::getModel, model, class_765.field_32767, overlay, stencilMap, emission, defaultTexture, textureBlend);
            }
            finally
            {
                RenderSystem.depthMask(savedDepthMask);
    ...
    private void renderShapeKeyGlowOverlay(class_4587 stack, ModelInstance model, int overlay, StencilMap stencilMap, Color color, Link defaultTexture, TextureBlend textureBlend, GlowSettings glow, Color legacyGlow)
    {
    ...
    private void drawShapeKeyGlowOverlayLayer(class_4587 stack, ModelInstance model, int overlay, StencilMap stencilMap, ShapeKeys shapeKeys, Link defaultTexture, TextureBlend textureBlend, Color glowLayerColor, boolean boneGlowOnly, float overlayIntensity, String targetGroupId, boolean skipBoneGlowGroups)
    {
    ...
    private void renderModelGeometry(class_4587 stack, Supplier<class_5944> program, ModelInstance model, int light, int overlay, StencilMap stencilMap, Color color, Link defaultTexture, TextureBlend textureBlend)
    {
        ShapeKeys shapeKeys = this.form.shapeKeys.get();
        ...
        else if (model.supportsBbsModelShaderEffects() && (program.get() == BBSShaders.getModel() || ModelVAORenderer.isPaintOverlayPass()))
        {
            ...
            Supplier<class_5944> blendProgram = BBSShaders::getModel;
    ...
    private Supplier<class_5944> getModelShader(ModelInstance model)
    {
        if (!model.supportsBbsModelShaderEffects())
        {
            return class_757::method_34507;
        }
    ...
    private void renderArmor(IEntity target, class_4587 stack, ArmorType type, ArmorSlot armorSlot, Color color, int overlay, int light)
    {
        ...
        if (matrix != null)
        {
            ...
            stack.method_22907(class_7833.field_40714.rotationDegrees(180F));
    ...
    private void renderItems(IEntity target, ModelInstance model, class_4587 stack, class_1304 slot, class_811 mode, List<ArmorSlot> items, ArmorSlot globalTransform, Color color, int overlay, int light)
    {
        ...
        for (ArmorSlot armorSlot : items)
        {
            ...
            if (matrix != null)
            {
                ...
                stack.method_46416(0F, 0.125F, 0F);
                ...
                class_1268 activeHand = target.getActiveHand();
                class_1304 activeSlot = activeHand == class_1268.field_5810 ? class_1304.field_6171 : class_1304.field_6173;
                class_1309 itemEntity = slot == activeSlot
                ...
                {
                    stack.method_22903();
                    stack.method_22905(0F, 0F, 0F);
                    class_310.method_1551().method_1480().method_23177(null, new class_1799(class_1802.field_8780), mode, mode == class_811.field_4323, stack, consumers, target.getWorld(), light, overlay, 0);
                    consumers.draw();
                    stack.method_22909();
                }

                class_310.method_1551().method_1480().method_23177(itemEntity, itemStack, mode, mode == class_811.field_4323, stack, consumers, target.getWorld(), light, overlay, 0);
                consumers.draw();
    ...
    {
        this.ensureAnimator(class_310.method_1551().method_60646().method_60637(true));
        ModelInstance model = this.getModel();

        if (this.animator != null && model != null)
        {
            ArmorSlot slot = hand == class_1268.field_5808 ? model.fpMain : model.fpOffhand;
            ...
            matrices.method_22907(class_7833.field_40716.rotation(MathUtils.PI));
            ...
            this.renderModel(this.entity, mainShader, matrices, model, light, class_4608.field_21444, color, false, null, 0F, true, null, null);
    ...
    public void render3D(FormRenderingContext context)
    {
        ...
        if (this.animator != null && model != null)
        {
            ...
            {
                context.world.method_22907(class_7833.field_40716.rotation(MathUtils.PI));
            }
            ...
            FormColorBlend.applyShadowPassColorFix(color, this.form.getFormColor(), this.form.paintSettings.get(), this.form.paintColor.get(), context.isShadowPass || BBSRendering.isIrisShadowPass(), this.hasAnyPaint(model));
    ...
    public void collectMatrices(IEntity entity, class_4587 stack, MatrixCache matrices, String prefix, float transition)
    {
        ...
        for (Map.Entry<String, MatrixCacheEntry> entry : this.bones.entrySet())
        {
            ...
            matrix.set(stack.method_23760().method_23761());
            stack.method_22909();

            stack.method_22903();
            MatrixStackUtils.multiply(stack, entry.getValue().origin());
            o.set(stack.method_23760().method_23761());
            stack.method_22909();
