...
public class LabelFormRenderer extends FormRenderer<LabelForm>
{
    ...
    public void renderInUI(UIContext context, int x1, int y1, int x2, int y2)
    {
        ...
        stack.method_22903();
        stack.method_46416(startX, y, 0F);
    ...
    public void render3D(FormRenderingContext context)
    {
        ...
        if (this.form.billboard.get())
        {
            ...
            context.stack.method_23760().method_23762().scale(
        ...
        {
            context.stack.method_46416(0F, -0.5F, 0F);
    ...
    /**
     * Text {@link net.minecraft.class_1921}s restore GL culling in
    ...
    private void renderTextShadow(FormRenderingContext context, CustomVertexConsumerProvider consumers, class_327 renderer, TextureFont customFont, String content, float x, float y, float letterSpacing, int light, Color shadowColor)
    {
        if (shadowColor.a <= 0)
        {
            return;
        ...
        context.stack.method_22903();
        context.stack.method_46416(0F, 0F, -0.05F);
    ...
    private void drawSimpleText(FormRenderingContext context, CustomVertexConsumerProvider consumers, class_327 renderer, TextureFont customFont, String content, float x, float y, float letterSpacing, int light, int color)
    {
        if (customFont != null)
        {
            customFont.draw(content, x, y, color, color, letterSpacing, 0F, context.stack.method_23760().method_23761(), consumers, light);
        }
        else
        {
            renderer.method_27521(
                content,
                x,
                y,
                color, false,
                context.stack.method_23760().method_23761(),
                consumers,
    ...
    private void renderTextGlowOverlay(FormRenderingContext context, CustomVertexConsumerProvider consumers, class_327 renderer, TextureFont customFont, String content, float x, float y, float letterSpacing, GlowSettings glowSettings, Color legacyGlow, float alpha, float glowIntensity, int textColor)
    {
        ...
        context.stack.method_22903();
        context.stack.method_46416(0F, 0F, 0.002F);
        ...
        try
        {
            ...
            if (customFont != null)
            {
                customFont.draw(content, x, y, textColor, textColor, letterSpacing, 0F, context.stack.method_23760().method_23761(), consumers, maxLight);
            }
            else
            {
                renderer.method_27521(
    ...
    private void renderString(FormRenderingContext context, CustomVertexConsumerProvider consumers, class_327 renderer, int light)
    {
        ...
        int w = customFont != null ? customFont.getWidth(content, letterSpacing) : renderer.method_1727(content) - 1;
        int h = customFont != null ? customFont.getHeight() : renderer.field_2000 - 2;
        ...
        if (this.form.outline.get())
        {
            ...
            context.stack.method_22903();
            context.stack.method_46416(0, 0, -0.025F);
            
            if (customFont != null)
            {
                customFont.draw(content, x - ow, y, oc, oc, letterSpacing, 0F, context.stack.method_23760().method_23761(), consumers, light);
                customFont.draw(content, x + ow, y, oc, oc, letterSpacing, 0F, context.stack.method_23760().method_23761(), consumers, light);
                customFont.draw(content, x, y - ow, oc, oc, letterSpacing, 0F, context.stack.method_23760().method_23761(), consumers, light);
                customFont.draw(content, x, y + ow, oc, oc, letterSpacing, 0F, context.stack.method_23760().method_23761(), consumers, light);
            }
            else
            {
                renderer.method_27521(content, x - ow, y, oc, false, context.stack.method_23760().method_23761(), consumers, class_327.class_6415.field_33993, 0, light);
                renderer.method_27521(content, x + ow, y, oc, false, context.stack.method_23760().method_23761(), consumers, class_327.class_6415.field_33993, 0, light);
                renderer.method_27521(content, x, y - ow, oc, false, context.stack.method_23760().method_23761(), consumers, class_327.class_6415.field_33993, 0, light);
                renderer.method_27521(content, x, y + ow, oc, false, context.stack.method_23760().method_23761(), consumers, class_327.class_6415.field_33993, 0, light);
            }
        ...
        if (customFont != null)
        {
            ...
            customFont.draw(content, x, y, c1, c2, letterSpacing, 0F, context.stack.method_23760().method_23761(), consumers, light, this.form.gradientOffset.get());
        }
        else
        {
            renderer.method_27521(
    ...
    private void renderLimitedString(FormRenderingContext context, CustomVertexConsumerProvider consumers, class_327 renderer, int light)
    {
        ...
        {
            int lw = customFont != null ? customFont.getWidth(line, letterSpacing) : renderer.method_1727(line) - 1;
            w = Math.max(lw, w);
        }

        int fh = customFont != null ? customFont.getHeight() : renderer.field_2000;
        ...
        for (String line : lines)
        {
            ...
            if (this.form.outline.get())
            {
                ...
                if (customFont != null)
                {
                    customFont.draw(line, lx - ow, y, oc, oc, letterSpacing, 0F, context.stack.method_23760().method_23761(), consumers, light);
                    customFont.draw(line, lx + ow, y, oc, oc, letterSpacing, 0F, context.stack.method_23760().method_23761(), consumers, light);
                    customFont.draw(line, lx, y - ow, oc, oc, letterSpacing, 0F, context.stack.method_23760().method_23761(), consumers, light);
                    customFont.draw(line, lx, y + ow, oc, oc, letterSpacing, 0F, context.stack.method_23760().method_23761(), consumers, light);
                }
                else
                {
                    renderer.method_27521(line, lx - ow, y, oc, false, context.stack.method_23760().method_23761(), consumers, class_327.class_6415.field_33993, 0, light);
                    renderer.method_27521(line, lx + ow, y, oc, false, context.stack.method_23760().method_23761(), consumers, class_327.class_6415.field_33993, 0, light);
                    renderer.method_27521(line, lx, y - ow, oc, false, context.stack.method_23760().method_23761(), consumers, class_327.class_6415.field_33993, 0, light);
                    renderer.method_27521(line, lx, y + ow, oc, false, context.stack.method_23760().method_23761(), consumers, class_327.class_6415.field_33993, 0, light);
                }
                context.stack.method_22909();
            }
            ...
            if (customFont != null)
            {
                ...
                customFont.draw(line, lx, y, c1, c2, letterSpacing, 0F, context.stack.method_23760().method_23761(), consumers, light);
            }
            else
            {
                renderer.method_27521(
    ...
    private void renderShadow(FormRenderingContext context, int x, int y, int w, int h)
    {
        ...
        context.stack.method_22903();
        context.stack.method_46416(0, 0, -0.2F);
