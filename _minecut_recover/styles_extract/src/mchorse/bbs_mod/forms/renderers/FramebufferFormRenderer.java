...
public class FramebufferFormRenderer extends FormRenderer<FramebufferForm>
{
    ...
    public void renderBodyParts(FormRenderingContext context)
    {
        ...
        RenderSystem.setProjectionMatrix(new Matrix4f().setOrtho(-1F, 1F, 1F, -1F, -500F, 500F), class_8251.field_43361);
    ...
    private class_4588 fill(class_293 format, class_4588 consumer, Matrix4f matrix, float x, float y, Color color, float u, float v, int overlay, int light, class_4587.class_4665 entry, float nz)
    {
        ...
        {
            return consumer.method_22918(matrix, x, y, 0F).method_22913(u, v).method_60803(light).method_22915(color.r, color.g, color.b, color.a);
        }

        if (format == class_290.field_1575)
        {
            return consumer.method_22918(matrix, x, y, 0F).method_22913(u, v).method_22915(color.r, color.g, color.b, color.a);
        }

        return consumer.method_22918(matrix, x, y, 0F).method_22915(color.r, color.g, color.b, color.a).method_22913(u, v).method_22922(overlay).method_60803(light).method_60831(entry, 0F, 0F, nz);
    }
}