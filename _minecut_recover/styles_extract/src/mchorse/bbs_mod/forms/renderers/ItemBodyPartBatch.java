...
public final class ItemBodyPartBatch
{
    ...
    private static class_1087 cachedModel;
    ...
    public static class_1087 getCachedModel()
    {
        return cachedModel;
    }
    ...
    public static boolean renderBodyParts(FormRenderer parent, List<BodyPart> parts, FormRenderingContext context)
    {
        ...
        class_1799 itemStack = template.stack.get();
        class_1937 world = context.entity != null && context.entity.getWorld() != null
            ? context.entity.getWorld()
            : client.field_1687;
        class_1087 bakedModel = client.method_1480().method_4012().method_3308(itemStack);

        if (bakedModel != null)
        {
            class_638 clientWorld = world instanceof class_638 typed ? typed : null;

            bakedModel = bakedModel.method_4710().method_3495(bakedModel, itemStack, clientWorld, null, 0);
        }
        ...
        class_811 mode = itemRenderer.getRenderMode(useDroppedMode);
        ...
        try
        {
            for (BodyPart part : parts)
            {
                ...
                try
                {
                    ...
                    client.method_1480().method_23179(itemStack, mode, leftHand, context.stack, consumers, context.light, context.overlay, bakedModel);
    ...
    {
        if (!class_1799.method_7973(a.stack.get(), b.stack.get()))
        {
            return false;
        }
