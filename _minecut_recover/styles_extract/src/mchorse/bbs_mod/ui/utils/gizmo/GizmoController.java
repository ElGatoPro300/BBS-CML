...
public class GizmoController
{
    ...
    public boolean tryStartHandleDrag(UIContext context, UIPropTransform transform)
    {
        ...
        /* Ctrl = bone multi-select; never steal the click for gizmo/trackball. */
        ...
        /* A real bone/form under the cursor always wins over the trackball sphere.
         * Otherwise the gizmo steals limb clicks whenever Transform/Pose has the gizmo up. */
