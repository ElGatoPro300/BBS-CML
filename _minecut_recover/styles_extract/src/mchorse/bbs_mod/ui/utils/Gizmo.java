...
public class Gizmo
{
    ...
    /** Camera distance used by the last {@link #computeScale(class_4587)} call. */
     ...
     */
    public void captureVisual(class_4587 stack)
    {
    ...
    public void renderInterface(UIContext context, Matrix4f projection, Area area)
    {
        ...
        int vy = (int) (mc.method_22683().method_4507() - (area.y + area.h) * ry);
    ...
    public void renderDeferred(class_4587 stack)
    {
        ...
        for (DeferredGizmo deferred : this.deferredGizmos)
        {
            if (iris)
            {
                ...
                RenderSystem.setProjectionMatrix(deferred.projection, class_8251.field_43361);
            }
            ...
            stack.method_23760().method_23761().set(deferred.matrix);
    ...
    private float computeScale(class_4587 stack)
    {
        ...
        Matrix4f inv = new Matrix4f(stack.method_23760().method_23761()).invert();
    ...
    public void renderStencil(class_4587 stack, StencilMap map)
    {
        ...
        RenderSystem.setShader(class_757::method_34540);
        RenderSystem.setShaderColor(1F, 1F, 1F, 1F);
        /* Match renderInterface: handles must pick on top of the mesh. Depth-tested
         * stencil made the head/body steal trackball and axis clicks. */
        RenderSystem.disableDepthTest();
        RenderSystem.depthMask(false);
    ...
    /** Minecraft 1.21 throws if {@link class_287#method_60800()} is called with no vertices
     *  (e.g. trackball-only stencil while the frosted sphere skips the pick pass). */
    private void drawBufferIfNotEmpty(class_287 builder)
    {
        try
        {
    ...
    private void box(class_287 builder, class_4587 stack, float x1, float y1, float z1, float x2, float y2, float z2, float[] color, float a)
    {
    ...
    private void drawTranslate(class_287 builder, class_4587 stack, float scale, float thickness, boolean stencil, StencilMap map)
    {
    ...
    private void drawMoveBars(class_287 builder, class_4587 stack, float axisSize, float axisOffset, boolean stencil, StencilMap map)
    {
     ...
     */
    private void drawMoveBars(class_287 builder, class_4587 stack, float axisSize, float axisOffset, boolean stencil, StencilMap map, boolean scaleCubesAtTip, float cubeHalf, float rotateCageRadius)
    {
     ...
     */
    private void drawCombinedAxisTip(class_287 builder, class_4587 stack, Axis axis, float shaftEnd, float tipRadius, float tipLength, float cubeHalf, int coneSegments, float[] translateColor, boolean stencil, float rotateCageRadius)
    {
    ...
    private void drawScaleTipCube(class_287 builder, class_4587 stack, Axis axis, float tip, float half, boolean stencil)
    {
    ...
    private void drawMovePlanes(class_287 builder, class_4587 stack, float planeInner, float planeOuter, float offset, boolean stencil, StencilMap map)
    {
    ...
    private void drawScreenCube(class_287 builder, class_4587 stack, float axisOffset, boolean stencil, StencilMap map)
    {
    ...
    private void drawScale(class_287 builder, class_4587 stack, float scale, float thickness, boolean stencil, StencilMap map)
    {
        float axisOffset = this.moveAxisOffset(scale, thickness);
        float axisSize = this.moveAxisLength(scale);
        float half = this.scaleHandleHalf(scale);
    ...
    private void drawTop(class_287 builder, class_4587 stack, float scale, float thickness, boolean stencil, StencilMap map)
    {
    ...
    private void drawRotate(class_287 builder, class_4587 stack, float scale, float thickness, boolean stencil, StencilMap map)
    {
    ...
    private void drawRings(class_287 builder, class_4587 stack, float radius, float ringThickness, int idX, int idY, int idZ, boolean stencil)
    {
     ...
     */
    private void drawAxisRotationRing(class_287 builder, class_4587 stack, Axis axis, float radius, float ringThickness, float[] color, boolean stencil)
    {
     ...
     */
    private void drawTrackball(class_287 builder, class_4587 stack, float radius, boolean stencil, StencilMap map)
    {
    ...
    private void drawViewRing(class_287 builder, class_4587 stack, float radius, float ringThickness, boolean stencil, StencilMap map)
    {
        ...
        stack.method_22903();
        stack.method_22907(new Quaternionf().rotationTo(0F, 1F, 0F, this.lastCamDir.x, this.lastCamDir.y, this.lastCamDir.z));
    ...
    private void drawRotationSweepArc(class_287 builder, class_4587 stack, Axis axis, float radius, float thickness, boolean viewRing)
    {
        ...
        {
            class_4587 arcStack = new class_4587();

            MatrixStackUtils.multiply(arcStack, this.arcFrozenMatrix);

            if (viewRing && this.arcFrozenViewRing)
            {
                arcStack.method_22907(new Quaternionf().rotationTo(0F, 1F, 0F, this.arcFrozenCamDir.x, this.arcFrozenCamDir.y, this.arcFrozenCamDir.z));
            }
    ...
    private void drawActiveGuide(class_287 builder, class_4587 stack, float scale, float thickness)
    {
    ...
    private void drawGuideLine(class_287 builder, class_4587 stack, float scale, float thickness, Axis axis, float[] color)
    {
    ...
    private void drawDragProgress(class_287 builder, class_4587 stack, float scale, float thickness)
    {
    ...
    private void drawCombined(class_287 builder, class_4587 stack, float scale, float thickness, boolean stencil, StencilMap map)
    {
        float moveScale = this.moveHandleScale(scale);
