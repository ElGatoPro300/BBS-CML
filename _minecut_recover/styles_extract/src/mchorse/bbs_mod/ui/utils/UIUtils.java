...
public class UIUtils
{
    ...
    public static void playClick(float pitch)
    {
        ...
        {
            class_310.method_1551().method_1483().method_4873(class_1109.method_4758(BBSMod.CLICK, pitch));
        }
        else
        {
            class_310.method_1551().method_1483().method_4873(class_1109.method_47978(class_3417.field_15015, pitch));
        }
    }
}