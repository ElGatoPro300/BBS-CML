...
public class UIItemFormPanel extends UIFormPanel<ItemForm>
{
    ...
    public UIItemFormPanel(UIForm editor)
    {
        ...
        this.modelTransform = new UIButton(IKey.EMPTY, (b) ->
        {
            this.getContext().replaceContextMenu((menu) ->
            {
                for (class_811 value : class_811.values())
                {
                    ...
                    {
                        menu.action(Icons.LINE, IKey.constant(value.method_15434()), true, () -> {});
                    }
                    else
                    {
                        menu.action(Icons.LINE, IKey.constant(value.method_15434()), () -> this.setModelTransform(value));
                    }
                }
            });
        });
        ...
        this.itemStackEditor = new UIItemStack((itemStack) -> this.form.stack.set(itemStack.method_7972()));
    ...
    private void setModelTransform(class_811 value)
    {
        this.form.modelTransform.set(value);

        this.modelTransform.label = IKey.constant(value.method_15434());
    }
    ...
    public void startEdit(ItemForm form)
    {
        ...
        this.modelTransform.label = IKey.constant(form.modelTransform.get().method_15434());
