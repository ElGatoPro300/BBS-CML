...
public class UIPickableFormRenderer extends UIFormRenderer implements GizmoSurface
{
    ...
    protected void renderUserModel(UIContext context)
    {
        ...
        FormRenderingContext formContext = new FormRenderingContext()
            .set(FormRenderType.PREVIEW, this.target == null ? this.entity : this.target, context.batcher.getContext().method_51448(), class_765.method_23687(15, 15), class_4608.field_21444, context.getTransition())
            .camera(this.camera)
            .modelRenderer()
            .equipment(false);
    ...
    private void renderFormHitbox(UIContext context)
    {
        ...
        Draw.renderBox(context.batcher.getContext().method_51448(), -thickness, -thickness + eyeHeight, -thickness, thickness, thickness, 2F, 1F, 0F, 0F);

        /* Draw hitbox */
        Draw.renderBox(context.batcher.getContext().method_51448(), -hitboxW / 2, 0, -hitboxW / 2, hitboxW, hitboxH, hitboxW);
    }
