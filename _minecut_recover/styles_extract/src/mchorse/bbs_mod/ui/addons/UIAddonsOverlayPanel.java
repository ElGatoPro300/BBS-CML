...
public class UIAddonsOverlayPanel extends UIOverlayPanel
{
    ...
    public static class UIAddonEntry extends UIElement
    {
        ...
        public void render(UIContext context)
        {
            ...
            context.batcher.getContext().method_51448().method_46416(this.area.x + textX, this.area.y + 10, 0);
            context.batcher.getContext().method_51448().method_22905(1.5F, 1.5F, 1.5F);
