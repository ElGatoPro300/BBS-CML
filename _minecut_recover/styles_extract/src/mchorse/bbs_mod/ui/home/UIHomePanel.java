...
public class UIHomePanel extends UIDashboardPanel
{
    ...
    private UIButton createHomeButton(IKey label, Icon icon, Consumer<UIButton> callback)
    {
        UIButton button = new UIButton(label, callback)
        {
            ...
            {
                int bg = this.hover && this.isEnabled() ? BBSSettings.baseSurface() : BBSSettings.deepSurface();
            ...
            try
            {
                ...
                if (resp.statusCode() == 200)
                {
                    ...
                    if (remote != null)
                    {
                        ...
                        class_310.method_1551().execute(() -> this.homeBanners.addAll(remote));
                    }
                }
            }
            catch (Exception e)
    ...
    private void renderHomeBanner(UIContext context)
    {
        ...
        for (int i = 0; i < segments; i++)
        {
            ...
            builder.method_22918(matrix4f, x1, yTop1f, 0).method_39415(colTop);
            ...
            builder.method_22918(matrix4f, x2, yTop1f, 0).method_39415(colTop);
            ...
            builder.method_22918(matrix4f, x1, yTop2f, 0).method_39415(colTop);
            ...
            builder.method_22918(matrix4f, x2, yTop2f, 0).method_39415(colTop);
    ...
    public void renderCardAndBanners(UIContext context, UIElement customHomePage, int dividerX, String listTitle, boolean showActionsColumn)
    {
        ...
        context.batcher.box(pageX, pageY, pageX + pageW, pageY + pageH, BBSSettings.chromeSurface());
        context.batcher.outline(pageX, pageY, pageX + pageW, pageY + pageH, BBSSettings.dividerColor(), 1);
        ...
        // Header Row
        context.batcher.box(pageX, splitY, pageX + pageW, splitY + 20, BBSSettings.baseSurface());
        context.batcher.outline(pageX, splitY, pageX + pageW, splitY + 20, BBSSettings.dividerColor(), 1);

        if (showActionsColumn)
        {
            context.batcher.box(pageX, splitY + 20, dividerX, pageY + pageH, BBSSettings.deepSurface());
            context.batcher.box(dividerX - 1, splitY + 20, dividerX, pageY + pageH, BBSSettings.dividerColor());
        ...
        private UIElement createCard(RecentAssetsTracker.Entry entry, int cx, int cy)
        {
            UIElement card = new UIElement()
            {
                ...
                private void renderIcon(UIContext context, Icon icon)
                {
                    ...
                    context.batcher.getContext().method_51448().method_46416(iconX, iconY, 0);
                    context.batcher.getContext().method_51448().method_22905(2F, 2F, 1F);
                    context.batcher.getContext().method_51448().method_46416(-iconX, -iconY, 0);
