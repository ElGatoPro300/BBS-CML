...
{
    private static final class_1799 SWORD = new class_1799(class_1802.field_8802);
    ...
    public void appear()
    {
        ...
        if (morph != null)
        {
            ...
            morph.entity.setEquipmentStack(class_1304.field_6173, SWORD);
            morph.entity.setEquipmentStack(class_1304.field_6171, SWORD);
        }
    ...
    public void disappear()
    {
        ...
        if (morph != null)
        {
            morph.entity.setEquipmentStack(class_1304.field_6173, class_1799.field_8037);
            morph.entity.setEquipmentStack(class_1304.field_6171, class_1799.field_8037);
        }
