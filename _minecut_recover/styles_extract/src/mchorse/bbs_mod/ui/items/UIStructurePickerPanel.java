...
public class UIStructurePickerPanel extends UIOverlayPanel
{
    ...
    public static void open()
    {
        ...
        if (player != null)
        {
            ...
            orbit.position.set(player.method_23317(), player.method_23320(), player.method_23321());
            orbit.rotation.set(
                MathUtils.toRad(player.method_36455()),
                MathUtils.toRad(player.method_5791() - 180),
                0F
            );
            orbit.fov = MathUtils.toRad(client.field_1690.method_41808().method_41753().floatValue());
        }
        ...
        panel.onClose((event) ->
        {
            ...
            if (client.field_1755 instanceof UIScreen)
            {
    ...
    public UIStructurePickerPanel()
    {
        ...
        this.modesPanel = new UIElement()
        {
            ...
            public void render(UIContext context)
            {
                ...
                context.render.batcher.getContext().method_51448().method_22903();
                context.render.batcher.getContext().method_51448().method_46416(slide, 0.0F, 0.0F);
                ...
                context.render.batcher.getContext().method_51448().method_22909();
            }
        };
    ...
    {
        class_2338 origin = StructurePickerClient.getPlacementOrigin();
        ...
        this.placementX.setValue(origin.method_10263());
        this.placementY.setValue(origin.method_10264());
        this.placementZ.setValue(origin.method_10260());
