...
public class UICurve extends UIElement
{
    ...
    private void drawGraph(UIContext context)
    {
        ...
        /* Top and bottom */
        builder.method_22918(matrix, this.area.x, this.graph.y, 0F).method_22915(0.5F, 0.5F, 0.5F, 0.5F);
        builder.method_22918(matrix, this.area.ex(), this.graph.y, 0F).method_22915(0.5F, 0.5F, 0.5F, 0.5F);

        builder.method_22918(matrix, this.area.x, this.graph.ey(), 0F).method_22915(0.5F, 0.5F, 0.5F, 0.5F);
        builder.method_22918(matrix, this.area.ex(), this.graph.ey(), 0F).method_22915(0.5F, 0.5F, 0.5F, 0.5F);

        /* Left and right */
        builder.method_22918(matrix, this.graph.x, this.area.y, 0F).method_22915(0.5F, 0.5F, 0.5F, 0.5F);
        builder.method_22918(matrix, this.graph.x, this.area.ey(), 0F).method_22915(0.5F, 0.5F, 0.5F, 0.5F);

        builder.method_22918(matrix, this.graph.ex(), this.area.y, 0F).method_22915(0.5F, 0.5F, 0.5F, 0.5F);
        builder.method_22918(matrix, this.graph.ex(), this.area.ey(), 0F).method_22915(0.5F, 0.5F, 0.5F, 0.5F);
        ...
        if (this.curve.type == ParticleCurveType.HERMITE && c >= 4)
        {
            ...
            /* Hermite bounds */
            builder.method_22918(matrix, (float) first.x, this.graph.y, 0F).method_22915(0.25F, 0.25F, 0.25F, 0.5F);
            builder.method_22918(matrix, (float) first.x, this.graph.ey(), 0F).method_22915(0.25F, 0.25F, 0.25F, 0.5F);

            builder.method_22918(matrix, (float) last.x, this.graph.y, 0F).method_22915(0.25F, 0.25F, 0.25F, 0.5F);
            builder.method_22918(matrix, (float) last.x, this.graph.ey(), 0F).method_22915(0.25F, 0.25F, 0.25F, 0.5F);
        }
