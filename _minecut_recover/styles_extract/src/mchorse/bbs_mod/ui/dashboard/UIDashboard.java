...
public class UIDashboard extends UIBaseMenu
{
    ...
    public void copyCurrentEntityCamera()
    {
        ...
        camera.rotation.set(MathUtils.toRad(cameraEntity.method_36455()), MathUtils.toRad(cameraEntity.method_5791() - 180), 0);
        camera.fov = MathUtils.toRad(class_310.method_1551().field_1690.method_41808().method_41753().floatValue());
