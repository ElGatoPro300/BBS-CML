...
public abstract class UISidebarDashboardPanel extends UIDashboardPanel
{
    ...
    protected void renderBackground(UIContext context)
    {
        ...
        {
            this.iconBar.area.render(context.batcher, BBSSettings.deepSurface());
            context.batcher.box(this.iconBar.area.x, this.iconBar.area.y, this.iconBar.area.x + 1, this.iconBar.area.ey(), BBSSettings.dividerColor());
        }
    }
}