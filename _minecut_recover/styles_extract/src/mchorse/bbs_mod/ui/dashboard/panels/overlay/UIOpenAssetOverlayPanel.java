...
public class UIOpenAssetOverlayPanel extends UIOverlayPanel
{
    ...
    protected void renderBackground(UIContext context)
    {
        ...
        // Header Row
        int headerH = 20;
        context.batcher.box(this.area.x, this.area.y, this.area.ex(), this.area.y + headerH, BBSSettings.baseSurface());
        context.batcher.outline(this.area.x, this.area.y, this.area.ex(), this.area.y + headerH, BBSSettings.dividerColor(), 1);

        // Left sidebar
        context.batcher.box(this.sidebar.area.x, this.sidebar.area.y, this.sidebar.area.ex(), this.area.ey(), BBSSettings.deepSurface());
        context.batcher.outline(this.sidebar.area.x, this.sidebar.area.y, this.sidebar.area.ex(), this.area.ey(), BBSSettings.dividerColor(), 1);

        // Toolbar bottom border
        context.batcher.box(this.toolbar.area.x, this.toolbar.area.ey() - 1, this.toolbar.area.ex(), this.toolbar.area.ey(), BBSSettings.dividerColor());
    ...
    public static class UITypeTab extends UIClickable<UITypeTab>
    {
        ...
        {
            int bg = this.selected ? BBSSettings.raisedSurface() : (this.hover ? BBSSettings.baseSurface() : BBSSettings.deepSurface());
            context.batcher.box(this.area.x + 2, this.area.y, this.area.ex() - 2, this.area.ey(), bg);

            if (this.selected)
            {
                context.batcher.box(this.area.x + 2, this.area.y, this.area.x + 5, this.area.ey(), BBSSettings.primaryColor(Colors.A100));
            }

            int textX = this.area.x + 8;
            int textColor = this.selected ? BBSSettings.primaryColor(Colors.A100) : 0xFFCCCCCC;
    ...
    public static class UIFolderCard extends UIClickable<UIFolderCard>
    {
        ...
        protected void renderSkin(UIContext context)
        {
            ...
            context.batcher.getContext().method_51448().method_46416(this.area.mx(), this.area.y + CARD_THUMB_H / 2F, 0);
