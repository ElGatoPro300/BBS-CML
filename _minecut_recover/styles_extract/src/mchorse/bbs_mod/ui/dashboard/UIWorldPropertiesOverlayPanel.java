...
public class UIWorldPropertiesOverlayPanel extends UIOverlayPanel
{
    ...
    public UIWorldPropertiesOverlayPanel()
    {
        ...
        this.freezeTime = new UIToggle(UIKeys.WORLD_FREEZE_TIME, !WorldPropertiesHelper.readGamerule(class_1928.field_19396, true), (b) ->
            WorldPropertiesHelper.setGamerule(class_1928.field_19396, !b.getValue()));
        ...
        this.pauseWeather = new UIToggle(UIKeys.WORLD_PAUSE_WEATHER, !WorldPropertiesHelper.readGamerule(class_1928.field_19406, true), (b) ->
            WorldPropertiesHelper.setGamerule(class_1928.field_19406, !b.getValue()));
        ...
        this.mobSpawning = new UIToggle(UIKeys.WORLD_MOB_SPAWN, WorldPropertiesHelper.readGamerule(class_1928.field_19390, true), (b) ->
            WorldPropertiesHelper.setGamerule(class_1928.field_19390, b.getValue()));
    ...
    private void syncFromWorld()
    {
        ...
        long timeOfDay = world == null ? 6000L : world.method_8532() % 24000L;
        ...
        this.freezeTime.setValue(!WorldPropertiesHelper.readGamerule(class_1928.field_19396, true));
        this.pauseWeather.setValue(!WorldPropertiesHelper.readGamerule(class_1928.field_19406, true));
        this.mobSpawning.setValue(WorldPropertiesHelper.readGamerule(class_1928.field_19390, true));
        this.gamma.setValue(WorldPropertiesHelper.getGammaPercent());
