...
public class UIWelcomePanel extends UIElement {
    ...
    private void drawPlayerHead(class_332 drawContext, class_2960 skinTexture, int x, int y, int size) {
        drawContext.method_25293(skinTexture, x, y, size, size, 8.0F, 8.0F, 8, 8, 64, 64);
        drawContext.method_25293(skinTexture, x, y, size, size, 40.0F, 8.0F, 8, 8, 64, 64);
    }
    ...
    public void render(UIContext context) {
        ...
        if (this.state == PopupState.WELCOME) {
            ...
            String username = mc.field_1724 != null ? mc.field_1724.method_7334().getName() : mc.method_1548().method_1676();
            class_2960 skinTexture = null;
            if (mc.field_1724 != null) {
                try {
                    skinTexture = mc.method_1582().method_52862(mc.field_1724.method_7334()).comp_1626();
                } catch (Exception e) {
                }
            }
            ...
            matrices.method_22903();
            matrices.method_22905(readyScale, readyScale, 1.0F);
