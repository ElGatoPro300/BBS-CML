...
public class UIMainMenuBar extends UIElement
{
    ...
    public void render(UIContext context)
    {
        ...
        context.batcher.box(this.area.x, this.area.y, this.area.ex(), this.area.ey(), style.chrome());
        context.batcher.box(this.area.x, this.area.ey() - 1, this.area.ex(), this.area.ey(), style.borderSoft());
        ...
        private void setSizeFromLabel(IKey label)
        {
            try
            {
                int textWidth = RtlAwtTextRenderer.isReady() && RtlTextEngine.isActive()
                    ...
                    : class_310.method_1551().field_1772.method_1727(label.get());
                this.w(textWidth + 10);
            }
            catch (Exception e)
            {
        ...
        public void resize()
        {
            try
            {
                int textWidth = RtlAwtTextRenderer.isReady() && RtlTextEngine.isActive()
                    ...
                    : class_310.method_1551().field_1772.method_1727(this.label.get());
                this.w(textWidth + 10);
            }
            catch (Exception e)
            {
