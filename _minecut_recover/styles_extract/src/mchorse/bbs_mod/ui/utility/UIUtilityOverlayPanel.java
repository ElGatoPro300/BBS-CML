...
public class UIUtilityOverlayPanel extends UIOverlayPanel
{
    ...
    public UIUtilityOverlayPanel(IKey title, Runnable callback)
    {
        ...
        this.width.delayedInput().limit(2, 4096, true).values(2, 1, 10).setValue(this.window.method_4480());
        this.height.delayedInput().limit(2, 4096, true).values(2, 1, 10).setValue(this.window.method_4507());
        ...
        UIButton cdnDownload = new UIButton(UIKeys.GENERAL_DOWNLOAD, (b) ->
        {
            ...
            Thread thread = new Thread(() ->
            {
                ...
                try
                {
                    ...
                    {
                        class_310.method_1551().execute(() -> panel.list.add(new Pair<>(p.a.color, p.b)));
                    });
