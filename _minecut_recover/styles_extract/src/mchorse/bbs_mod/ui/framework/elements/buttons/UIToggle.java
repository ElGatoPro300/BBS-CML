...
public class UIToggle extends UIClickable<UIToggle> implements ITextColoring
{
    ...
    protected void renderSkin(UIContext context)
    {
        ...
        int primary = mchorse.bbs_mod.ui.framework.styles.UIStyle.active().accent();
        ...
        int finalInactive = this.hover
            ? (mchorse.bbs_mod.ui.framework.styles.UIStyle.isMinecut() ? 0xFF3A3A3C : 0xFF4A4A52)
            : (mchorse.bbs_mod.ui.framework.styles.UIStyle.isMinecut() ? 0xFF2C2C2E : 0xFF3B3B43);
        ...
        {
            mchorse.bbs_mod.ui.framework.styles.UIStyle.active().drawSoftRect(batcher, x, y, w, h, trackColor);
        }
        else
        {
