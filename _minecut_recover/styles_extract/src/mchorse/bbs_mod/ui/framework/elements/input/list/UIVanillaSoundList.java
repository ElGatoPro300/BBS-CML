...
public class UIVanillaSoundList extends UIStringList
{
    ...
    private void loadVanillaSoundFiles()
    {
        ...
        try
        {
            ...
            class_2378<class_3414> soundRegistry = class_7923.field_41172;

            for (class_2960 soundId : soundRegistry.method_10235())
            {
                if (soundId.method_12836().equals("minecraft"))
                {
    ...
    private JsonObject loadSoundsJson(class_3300 resourceManager)
    {
        try
        {
            class_2960 soundsJsonId = class_2960.method_60655("minecraft", "sounds.json");
            Optional<class_3298> resource = resourceManager.method_14486(soundsJsonId);
    ...
    private String copyToTempFile(VanillaSoundAsset asset)
    {
        try
        {
            ...
            if (asset.actualSoundPaths != null && !asset.actualSoundPaths.isEmpty())
            {
                ...
                class_2960 soundFileId = class_2960.method_60655("minecraft", "sounds/" + soundPath);
                class_310 client = class_310.method_1551();
                Optional<class_3298> resource = client.method_1478().method_14486(soundFileId);
