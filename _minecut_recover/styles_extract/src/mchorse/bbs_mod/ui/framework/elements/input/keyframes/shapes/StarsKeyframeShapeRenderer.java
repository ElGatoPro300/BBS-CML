...
public class StarsKeyframeShapeRenderer implements IKeyframeShapeRenderer
{
    ...
    public void renderKeyframe(UIContext uiContext, class_287 builder, Matrix4f matrix, int x, int y, int offset, int c)
    {
        ...
        for (int i = 0; i < this.numBranches; i++)
        {
            ...
            builder.method_22918(matrix, baseLeft_x, baseLeft_y, 0).method_39415(c);
            builder.method_22918(matrix, tipLeft_x, tipLeft_y, 0).method_39415(c);
            builder.method_22918(matrix, tipRight_x, tipRight_y, 0).method_39415(c);
            builder.method_22918(matrix, baseRight_x, baseRight_y, 0).method_39415(c);
        }
    }
    ...
    public void renderKeyframeBackground(UIContext uiContext, class_287 builder, Matrix4f matrix, int x, int y, int offset, int c)
    {
        ...
        builder.method_22918(matrix, x - half, y - half, 0F).method_39415(c);
        builder.method_22918(matrix, x - half, y + half, 0F).method_39415(c);
        builder.method_22918(matrix, x + half, y + half, 0F).method_39415(c);
        builder.method_22918(matrix, x + half, y - half, 0F).method_39415(c);
    }
