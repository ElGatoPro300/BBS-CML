...
public abstract class UIContextMenu extends UIElement
{
    ...
    protected void renderBackground(UIContext context)
    {
        ...
        int color = style.accent() & Colors.RGB;
        ...
        if (mchorse.bbs_mod.ui.framework.styles.UIStyle.isMinecut())
        {
            ...
            style.drawPanel(context.batcher, this.area);
            context.batcher.outline(this.area.x, this.area.y, this.area.ex(), this.area.ey(), style.border());
        }
        else
        {
            context.batcher.dropShadow(this.area.x, this.area.y, this.area.ex(), this.area.ey(), 10, Colors.A25 | color, color);
