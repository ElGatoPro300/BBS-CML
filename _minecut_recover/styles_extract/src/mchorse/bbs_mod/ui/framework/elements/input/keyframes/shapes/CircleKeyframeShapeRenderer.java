...
public class CircleKeyframeShapeRenderer implements IKeyframeShapeRenderer
{
    ...
    public void renderKeyframe(UIContext uiContext, class_287 builder, Matrix4f matrix, int x, int y, int offset, int c)
    {
        ...
        for (int i = 0; i < NUM_SEGMENTS; i++)
        {
            ...
            builder.method_22918(matrix, innerX1, innerY1, 0F).method_39415(c);
            builder.method_22918(matrix, outerX1, outerY1, 0F).method_39415(c);
            builder.method_22918(matrix, outerX2, outerY2, 0F).method_39415(c);
            builder.method_22918(matrix, innerX2, innerY2, 0F).method_39415(c);
        }
    }
