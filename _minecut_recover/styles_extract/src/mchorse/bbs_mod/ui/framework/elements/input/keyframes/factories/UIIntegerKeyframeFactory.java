            ...
            this.hotbarPreview = new UIElement()
            {
                ...
                public void render(UIContext context)
                {
                    ...
                    for (int i = 0; i < 9; i++)
                    {
                        ...
                        {
                            List<class_1799> stacks = UIIntegerKeyframeFactory.this.replay.inventory.getStacks();
                            if (!stacks.isEmpty())
                            {
                                stack = stacks.size() > i ? stacks.get(i) : class_1799.field_8037;
                            }
                        }

                        if ((stack == null || stack.method_7960()) && UIIntegerKeyframeFactory.this.film != null)
                        {
                            List<class_1799> stacks = UIIntegerKeyframeFactory.this.film.inventory.getStacks();
                            if (!stacks.isEmpty())
                            {
                                stack = stacks.size() > i ? stacks.get(i) : class_1799.field_8037;
                            }
