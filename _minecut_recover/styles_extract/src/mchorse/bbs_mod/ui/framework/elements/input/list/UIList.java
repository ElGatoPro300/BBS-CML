...
public abstract class UIList <T> extends UIElement
{
    ...
    {
        Area row = new Area(x, y, this.area.w, this.scroll.scrollItemSize);

        mchorse.bbs_mod.ui.framework.styles.UIStyle.active().drawListSelection(context.batcher, row, selected, hover);
