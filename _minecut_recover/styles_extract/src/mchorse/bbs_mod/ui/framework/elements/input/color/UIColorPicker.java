...
public class UIColorPicker extends UIElement
{
    ...
    public static void renderAlphaPreviewQuad(Batcher2D batcher, int x1, int y1, int x2, int y2, Color color)
    {
        ...
        builder.method_22918(matrix4f, x1, y1, 0F).method_22915(color.r, color.g, color.b, 1);
        builder.method_22918(matrix4f, x1, y2, 0F).method_22915(color.r, color.g, color.b, 1);
        builder.method_22918(matrix4f, x2, y1, 0F).method_22915(color.r, color.g, color.b, 1);
        builder.method_22918(matrix4f, x2, y1, 0F).method_22915(color.r, color.g, color.b, color.a);
        builder.method_22918(matrix4f, x1, y2, 0F).method_22915(color.r, color.g, color.b, color.a);
        builder.method_22918(matrix4f, x2, y2, 0F).method_22915(color.r, color.g, color.b, color.a);
