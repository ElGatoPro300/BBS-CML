...
public class UITriggerBlockPanel extends UIDashboardPanel implements IFlightSupported
{
    ...
    {
        if (entity != null) ClientNetwork.sendTriggerBlockUpdate(entity.method_11016(), entity);
    }
    ...
    private void updateList()
    {
        ...
        if (this.entity != null && !this.entity.method_11015())
        {
    ...
    public void renderInWorld(WorldRenderContext context)
    {
        ...
        Vector3f mouseDirection = CameraUtils.getMouseDirection(
            ...
            context.matrixStack().method_23760().method_23761(),
            (int) mc.field_1729.method_1603(), (int) mc.field_1729.method_1604(), 0, 0, mc.method_22683().method_4480(), mc.method_22683().method_4507()
        );

        this.hovered = this.getClosestObject(new Vector3d(pos.field_1352, pos.field_1351, pos.field_1350), mouseDirection);
    ...
    private void renderBox(class_4587 stack, TriggerBlockEntity entity, float r, float g, float b)
    {
        class_2338 bp = entity.method_11016();
        ...
        double x = bp.method_10263() + minX;
        double y = bp.method_10264() + minY;
        double z = bp.method_10260() + minZ;
        double w = maxX - minX;
        double h = maxY - minY;
        double d = maxZ - minZ;
    ...
    private void renderRegionBox(class_4587 stack, TriggerBlockEntity entity, float r, float g, float b)
    {
        class_238 box = entity.getRegionBox();
        Draw.renderBox(stack, box.field_1323, box.field_1322, box.field_1321, box.field_1320 - box.field_1323, box.field_1325 - box.field_1322, box.field_1324 - box.field_1321, r, g, b);
    }
    ...
    private AABB getHitbox(TriggerBlockEntity closest)
    {
        ...
        return new AABB(pos.method_10263() + minX, pos.method_10264() + minY, pos.method_10260() + minZ, maxX - minX, maxY - minY, maxZ - minZ);
    }
