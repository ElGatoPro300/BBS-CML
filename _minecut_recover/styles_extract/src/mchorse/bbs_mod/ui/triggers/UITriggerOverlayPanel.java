        ...
        this.list.context((menu) ->
        {
            ...
            if (!this.list.getList().isEmpty())
            {
                menu.action(Icons.COPY, TriggerKeys.COPY_TRIGGER, () ->
                {
                    try
                    {
                        class_310.method_1551().field_1774.method_1455(DataStorageUtils.toNbt(this.item.toData()).toString());
                    }
                    catch (Exception e)
                    {}
                });
            ...
            try
            {
                ...
                class_2520 element = class_2522.method_10718(clipboard);
        ...
        else if (type.equals("block"))
        {
            ...
            UIButton pickBlock = new UIButton(TriggerKeys.PICK_BLOCK, (b) ->
            {
                ...
                UIModelBlockEntityList modelBlocks = new UIModelBlockEntityList((l) ->
                {
                    ...
                    item.x.set(entity.method_11016().method_10263());
                    item.y.set(entity.method_11016().method_10264());
                    item.z.set(entity.method_11016().method_10260());

                    x.setValue(entity.method_11016().method_10263());
                    y.setValue(entity.method_11016().method_10264());
                    z.setValue(entity.method_11016().method_10260());
