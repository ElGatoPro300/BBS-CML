...
public class UIImageRenderer
{
    ...
    public static void renderImages(class_4587 stack, Batcher2D batcher, List<ImageOverlay> images)
    {
        if (images.isEmpty())
        {
            return;
        ...
        Supplier<class_5944> supplier = class_757::method_34543;

        net.minecraft.class_276 fb = class_310.method_1551().method_1522();
        int width = fb.field_1482 / 2;
        int height = fb.field_1481 / 2;
    ...
    public static void renderImage(class_4587 stack, Batcher2D batcher, ImageOverlay overlay)
    {
        if (overlay == null)
        {
            return;
