...
public class UIFilmLogOverlayPanel extends UIOverlayPanel
{
    ...
    public static class UIContributorEntry extends UIElement
    {
        ...
        private void resolveProfile()
        {
            ...
            try
            {
                ...
                if (mc.method_1562() != null)
                {
                    ...
                    {
                        if (entry.method_2966().getName().equalsIgnoreCase(this.contributor.name.get()))
                        {
                            profile = entry.method_2966();
                            break;
                        }
                    }
                }
                ...
                this.skinTexture = mc.method_1582().method_52862(profile).comp_1626();
            }
            catch (Exception e)
            {}
        ...
        private void drawPlayerHead(class_332 drawContext, class_2960 texture, int x, int y, int size)
        {
            drawContext.method_25293(texture, x, y, size, size, 8.0F, 8.0F, 8, 8, 64, 64);
            drawContext.method_25293(texture, x, y, size, size, 40.0F, 8.0F, 8, 8, 64, 64);
        }
