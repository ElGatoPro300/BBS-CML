...
public class UISubtitleRenderer
{
    ...
    public static void renderSubtitles(class_4587 stack, Batcher2D batcher, List<Subtitle> subtitles)
    {
        ...
        net.minecraft.class_276 fb = class_310.method_1551().method_1522();
        ...
        class_327 vanilla = class_310.method_1551().field_1772;
        ...
        for (Subtitle subtitle : subtitles)
        {
            ...
            {
                w = Math.max(w, vanilla.method_1727(string.trim()));
            }

            h = (strings.size() - 1) * subtitle.lineHeight + vanilla.field_2000 - 2;
            ...
            RenderSystem.setProjectionMatrix(new Matrix4f().ortho(0, w + 10, 0, h + 10, -100, 100), class_8251.field_43361);
            ...
            for (String string : strings)
            {
                ...
                int xx = 5 + (int) ((w - vanilla.method_1727(string)) / 2);

                if (Colors.getA(subtitle.backgroundColor) > 0)
                {
                    float offset = subtitle.backgroundOffset;
                    int tw = vanilla.method_1727(string);
                    int th = vanilla.field_2000 - 2;
            ...
            if (blur != null)
            {
                blur.method_1255(subtitle.shadow, subtitle.shadowOpaque ? 1F : 0F);
            }
    ...
    public static void renderSubtitle(class_4587 stack, Batcher2D batcher, Subtitle subtitle)
    {
        if (subtitle == null)
        {
            return;
