...
public class UIImageClip extends UIClip<ImageClip>
{
    ...
    private void writeDouble(KeyframeChannel<Double> channel, ValueDouble uniform, double value)
    {
        ...
        {
            value = class_3532.method_15350(value, ImageClip.BLEND_MIN, ImageClip.BLEND_MAX);
        }
        else if (channel == this.clip.opacity)
        {
            value = class_3532.method_15350(value, ImageClip.OPACITY_MIN, ImageClip.OPACITY_MAX);
        }
    ...
    {
        return class_3532.method_15340(this.editor.getCursor() - this.clip.tick.get(), 0, this.clip.duration.get());
    }
