...
public class UIReplayList extends UIList<Replay> {
    ...
    private Double getTerrainY(class_1937 world, double x, double z) {
        int top = world.method_31600();
        int bottom = world.method_31607();
        double distance = Math.max(0D, top - bottom + 2D);
        class_243 start = new class_243(x, top + 1D, z);
        class_3965 result = RayTracing.rayTrace(world, start, new class_243(0D, -1D, 0D), distance);
    ...
    public void addReplay() {
        ...
        class_3965 blockHitResult = RayTracing.rayTrace(world, camera, 64F);
    ...
    private void fromModelBlock() {
        ...
        class_243 playerPos = client.field_1724 != null ? client.field_1724.method_19538() : class_243.field_1353;
        ...
        modelBlocks.sort(Comparator.comparingDouble((ModelBlockEntity block) ->
            playerPos.method_1025(class_243.method_24953(block.method_11016()))));

        for (ModelBlockEntity modelBlock : modelBlocks) {
            int blocksAway = (int) Math.round(Math.sqrt(playerPos.method_1025(class_243.method_24953(modelBlock.method_11016()))));
    ...
    private void fromModelBlock(ModelBlockEntity modelBlock) {
        ...
        double x = blockPos.method_10263() + transform.translate.x + 0.5D;
        double y = blockPos.method_10264() + transform.translate.y;
        double z = blockPos.method_10260() + transform.translate.z + 0.5D;
