...
public class UIReplaysOverlayPanel extends UIOverlayPanel
{
    ...
    public UIReplaysOverlayPanel(UIFilmPanel filmPanel, Consumer<Replay> callback)
    {
        ...
        this.replayProperties = UI.scrollView(4, 2);
    ...
    public void attachPropertiesHost(UIElement host)
    {
        ...
        /* Force remount even when already external — host may have changed
           (e.g. Classic properties panel → Minecut Replay tab). */
        this.propertiesExternal = false;
    ...
    protected void renderBackground(UIContext context)
    {
        ...
        this.content.area.render(context.batcher, BBSSettings.chromeSurface());

        if (this.replays.getList().isEmpty())
        {
            UIDataUtils.renderRightClickHere(context, this.replays.area, BBSSettings.chromeSurface());
        }
    }
}
