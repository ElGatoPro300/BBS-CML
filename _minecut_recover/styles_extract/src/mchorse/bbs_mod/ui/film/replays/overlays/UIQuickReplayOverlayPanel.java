...
public class UIQuickReplayOverlayPanel extends UIOverlayPanel
{
    ...
    private void centerCursor(UIContext context)
    {
        ...
        net.minecraft.class_1041 mcWindow = class_310.method_1551().method_22683();
        double fx = mcWindow.method_4480() / (double) context.menu.width;
        double fy = mcWindow.method_4507() / (double) context.menu.height;
    ...
    public boolean subKeyPressed(UIContext context)
    {
        ...
        class_304 keybind = BBSModClient.getKeyOpenQuickReplays();

        if (keybind != null && context.getKeyAction() == KeyAction.PRESSED && keybind.method_1417(context.getKeyCode(), context.getScanCode()))
        {
