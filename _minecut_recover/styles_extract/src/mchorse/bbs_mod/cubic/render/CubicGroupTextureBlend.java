...
public final class CubicGroupTextureBlend
{
    ...
    public static boolean supportsShader(class_5944 shader)
    {
        if (shader == null)
        {
            return false;
        ...
        class_284 uniform = shader.method_34582("TextureBlendActive");
     ...
     */
    public static void bindForDraw(class_5944 shader, CubicGroupTextureBlend state, Link defaultTexture)
    {
        if (state == null)
        {
