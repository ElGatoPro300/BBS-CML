...
public class LightmapModelVAO implements IModelVAO
{
    ...
    @Override
    public void render(class_293 format, float r, float g, float b, float a, int light, int overlay)
    {
        ...
        if (this.hasVertexColors)
        {
            ...
            if (shader != null && shader.field_29474 != null)
            {
                shader.field_29474.method_35657(r, g, b, a);
            }
        }
        else
        {
