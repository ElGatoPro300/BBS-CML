...
public class ModelInstance implements IModelInstance
{
    ...
    public void setup()
    {
        ...
        {
            class_310.method_1551().execute(model::setup);
        }
    ...
    public void render(class_4587 stack, Supplier<class_5944> program, Color color, int light, int overlay, StencilMap stencilMap, ShapeKeys keys, Link defaultTexture)
    {
        if (this.model instanceof Model model)
        {
    ...
    public void renderShapeKeyGlowOverlay(class_4587 stack, Color glowLayerColor, int overlay, StencilMap stencilMap, ShapeKeys keys, Link defaultTexture, boolean boneGlowOnly, float overlayIntensity, String targetGroupId, boolean skipBoneGlowGroups)
    {
        ...
        class_5944 shader = class_757.method_34507();
        Link texture = defaultTexture != null ? defaultTexture : this.texture;
