...
public final class DynamicBoneOrchestrator
{
    ...
    private static void applyCompiled(class_1937 world, int age, float transition, IModel model, ModelInstance instance, List<SpringChainCompiler.CompiledChain> compiledChains, WindDef wind, Map<String, JointLimitConfig.JointLimit> jointLimits, InstanceState state, Matrix4f baseTransform)
    {
    ...
    private static void applyChain(class_1937 world, int age, float transition, IModel model, ModelInstance instance, SpringChainCompiler.CompiledChain chain, WindDef wind, Map<String, JointLimitConfig.JointLimit> jointLimits, Map<String, PivotFrame> frames, InstanceState instanceState)
    {
