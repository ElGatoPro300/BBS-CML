...
public class GeckoAnimationMath
{
    ...
    {
        return (class_3532.method_15362(-age * 0.09F) * 0.05F + 0.05F) * direction;
    }

    public static float idlePitch(float age, float direction)
    {
        return class_3532.method_15374(-age * 0.067F) * 0.05F * direction;
    }
    ...
    public static float swingPitch(float limbPhase, float limbSpeed, float movementCoefficient, boolean left)
    {
        ...
        return class_3532.method_15362(limbPhase * WALK_SWING_FREQUENCY + offset) * limbSpeed / Math.max(0.001F, movementCoefficient);
    }
    ...
    {
        float factor = class_3532.method_15363(lerpFactor, 0F, 1F);
    ...
    public static float swipePitch(float handSwing)
    {
        ...
        return class_3532.method_15374(factor * (float) Math.PI) * 1.2F;
    }

    public static float swipeRoll(float handSwing)
    {
        return class_3532.method_15374(handSwing * (float) Math.PI) * -0.4F;
    }
}
